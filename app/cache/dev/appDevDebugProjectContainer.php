...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/tgs/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/wamp/www/tgs/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PageBundle', 'C:/wamp/www/tgs/app/Resources/PageBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'PageBundle', 'C:\\wamp\\www\\tgs\\src\\Maynard\\PageBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BlogBundle', 'C:/wamp/www/tgs/app/Resources/BlogBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BlogBundle', 'C:\\wamp\\www\\tgs\\src\\Maynard\\BlogBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'RecipeBundle', 'C:/wamp/www/tgs/app/Resources/RecipeBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'RecipeBundle', 'C:\\wamp\\www\\tgs\\src\\Maynard\\RecipeBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ProductBundle', 'C:/wamp/www/tgs/app/Resources/ProductBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ProductBundle', 'C:\\wamp\\www\\tgs\\src\\Maynard\\ProductBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSUserBundle', 'C:/wamp/www/tgs/app/Resources/FOSUserBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'FOSUserBundle', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', 'C:/wamp/www/tgs/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    {
        $this->services['assetic.filter.compass'] = $instance = new \Assetic\Filter\CompassFilter('C:\\Program Files (x86)\\Ruby193\\bin\\compass', 'c:\\Program Files (x86)\\Ruby193\\bin\\ruby.EXE');

        $instance->setTimeout(NULL);
        $instance->setDebugInfo(false);
        $instance->setNoLineComments(false);
        $instance->setStyle(NULL);
        $instance->setImagesDir('C:/wamp/www/tgs/app/../web/images');
    ...
    {
        $this->services['assetic.filter.sass'] = $instance = new \Assetic\Filter\Sass\SassFilter('C:\\Program Files (x86)\\Ruby193\\bin\\sass', 'c:\\Program Files (x86)\\Ruby193\\bin\\ruby.EXE');
    ...
    {
        $this->services['assetic.filter.scss'] = $instance = new \Assetic\Filter\Sass\ScssFilter('c:\\Program Files (x86)\\Ruby193\\bin\\sass.BAT', 'c:\\Program Files (x86)\\Ruby193\\bin\\ruby.EXE');
    ...
    {
        $this->services['assetic.filter.yui_css'] = $instance = new \Assetic\Filter\Yui\CssCompressorFilter('C:/wamp/www/tgs/app/Resources/java/yuicompressor.jar', 'C:\\Program Files (x86)\\Java\\jre6\\bin\\java.exe');
    ...
    {
        $this->services['assetic.filter.yui_js'] = $instance = new \Assetic\Filter\Yui\JsCompressorFilter('C:/wamp/www/tgs/app/Resources/java/yuicompressor.jar', 'C:\\Program Files (x86)\\Java\\jre6\\bin\\java.exe');
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('cssrewrite' => 'assetic.filter.cssrewrite', 'sass' => 'assetic.filter.sass', 'compass' => 'assetic.filter.compass', 'scss' => 'assetic.filter.scss', 'yui_css' => 'assetic.filter.yui_css', 'yui_js' => 'assetic.filter.yui_js'));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/wamp/www/tgs/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'tgs_cms', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'unix_socket' => NULL, 'driver' => 'pdo_mysql', 'driverOptions' => array()), $b, $c, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager520ed5c38b532_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager520ed5c38b532_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'C:/wamp/www/tgs/app/cache/dev/jms_diextra/doctrine/EntityManager_520ed5c38b532.php';

        $a = $this->get('annotation_reader');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_40ec276604fd6dacd9494142960226e2');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_40ec276604fd6dacd9494142960226e2');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_40ec276604fd6dacd9494142960226e2');

        $e = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array('C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine' => 'FOS\\UserBundle\\Entity', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle\\Resources\\config\\doctrine' => 'Sonata\\UserBundle\\Entity', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\media-bundle\\Sonata\\MediaBundle\\Resources\\config\\doctrine' => 'Sonata\\MediaBundle\\Entity', 'C:\\wamp\\www\\tgs\\src\\Application\\Sonata\\MediaBundle\\Resources\\config\\doctrine' => 'Application\\Sonata\\MediaBundle\\Entity', 'C:\\wamp\\www\\tgs\\src\\Application\\Sonata\\UserBundle\\Resources\\config\\doctrine' => 'Application\\Sonata\\UserBundle\\Entity'));
        $e->setGlobalBasename('mapping');

        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => 'C:\\wamp\\www\\tgs\\src\\Maynard\\SettingsBundle\\Entity', 1 => 'C:\\wamp\\www\\tgs\\src\\Maynard\\MenuBundle\\Entity', 2 => 'C:\\wamp\\www\\tgs\\src\\Maynard\\PageBundle\\Entity', 3 => 'C:\\wamp\\www\\tgs\\src\\Maynard\\BlogBundle\\Entity', 4 => 'C:\\wamp\\www\\tgs\\src\\Maynard\\RecipeBundle\\Entity', 5 => 'C:\\wamp\\www\\tgs\\src\\Maynard\\ProductBundle\\Entity'));
        ...
        $g->addDriver($e, 'Application\\Sonata\\MediaBundle\\Entity');
        $g->addDriver($e, 'Application\\Sonata\\UserBundle\\Entity');
        $g->addDriver($f, 'Maynard\\SettingsBundle\\Entity');
        $g->addDriver($f, 'Maynard\\MenuBundle\\Entity');
        $g->addDriver($f, 'Maynard\\PageBundle\\Entity');
        $g->addDriver($f, 'Maynard\\BlogBundle\\Entity');
        $g->addDriver($f, 'Maynard\\RecipeBundle\\Entity');
        $g->addDriver($f, 'Maynard\\ProductBundle\\Entity');

        $h = new \Doctrine\ORM\Configuration();
        $h->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'SonataUserBundle' => 'Sonata\\UserBundle\\Entity', 'SonataMediaBundle' => 'Sonata\\MediaBundle\\Entity', 'ApplicationSonataMediaBundle' => 'Application\\Sonata\\MediaBundle\\Entity', 'ApplicationSonataUserBundle' => 'Application\\Sonata\\UserBundle\\Entity', 'SettingsBundle' => 'Maynard\\SettingsBundle\\Entity', 'MenuBundle' => 'Maynard\\MenuBundle\\Entity', 'PageBundle' => 'Maynard\\PageBundle\\Entity', 'BlogBundle' => 'Maynard\\BlogBundle\\Entity', 'RecipeBundle' => 'Maynard\\RecipeBundle\\Entity', 'ProductBundle' => 'Maynard\\ProductBundle\\Entity'));
        $h->setMetadataCacheImpl($b);
        $h->setQueryCacheImpl($c);
        $h->setResultCacheImpl($d);
        $h->setMetadataDriverImpl($g);
        $h->setProxyDir('C:/wamp/www/tgs/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager520ed5c38b532_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($i, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/wamp/www/tgs/app/Resources');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => 'FOSUserBundle:Registration:confirm_email.txt.twig', 'resetting' => 'FOSUserBundle:Resetting:email.txt.twig'), 'from_email' => array('confirmation' => array('info@thegreekspots.co.uk' => 'TGS'), 'resetting' => array('info@thegreekspots.co.uk' => 'TGS'))));
    }
    ...
    {
        return $this->services['fos_user.registration.form'] = $this->get('form.factory')->createNamed('fos_user_registration_form', 'registration', NULL, array('validation_groups' => array(0 => 'Registration', 1 => 'Default')));
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('C:/wamp/www/tgs/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['knp_menu.menu_provider'] = new \Knp\Menu\Provider\ChainProvider(array(0 => new \Knp\Bundle\MenuBundle\Provider\ContainerAwareProvider($this, array('main' => 'maynard_menu.menu.main', 'smallfooter' => 'maynard_menu.menu.smallfooter', 'footer' => 'maynard_menu.menu.footer', 'mainsitemap' => 'maynard_menu.menu.mainsitemap', 'footersitemap' => 'maynard_menu.menu.footersitemap')), 1 => new \Knp\Bundle\MenuBundle\Provider\BuilderAliasProvider($this->get('kernel'), $this, $this->get('knp_menu.factory'))));
    }
    ...
    /**
     * Gets the 'maynard_menu.menu.footer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getMaynardMenu_Menu_FooterService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('maynard_menu.menu.footer', 'request');
        }

        return $this->services['maynard_menu.menu.footer'] = $this->scopedServices['request']['maynard_menu.menu.footer'] = $this->get('maynard_menu.menu_builder')->createMenu($this->get('request'), $this->get('doctrine.orm.default_entity_manager'), 'Footer Menu', 'footer-menu menu inline-list', 'simple');
    }

    /**
     * Gets the 'maynard_menu.menu.footersitemap' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Knp\Menu\MenuItem A Knp\Menu\MenuItem instance.
     */
    protected function getMaynardMenu_Menu_FootersitemapService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('maynard_menu.menu.footersitemap', 'request');
        }

        return $this->services['maynard_menu.menu.footersitemap'] = $this->scopedServices['request']['maynard_menu.menu.footersitemap'] = $this->get('maynard_menu.menu_builder')->createMenu($this->get('request'), $this->get('doctrine.orm.default_entity_manager'), 'Footer Menu', 'sitemapList side-nav', 'simple');
    }

    /**
     * Gets the 'maynard_menu.menu.main' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Knp\Menu\MenuItem A Knp\Menu\MenuItem instance.
     */
    protected function getMaynardMenu_Menu_MainService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('maynard_menu.menu.main', 'request');
        }

        return $this->services['maynard_menu.menu.main'] = $this->scopedServices['request']['maynard_menu.menu.main'] = $this->get('maynard_menu.menu_builder')->createMenu($this->get('request'), $this->get('doctrine.orm.default_entity_manager'), 'Main Menu', 'menu right', 'main');
    }

    /**
     * Gets the 'maynard_menu.menu.mainsitemap' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Knp\Menu\MenuItem A Knp\Menu\MenuItem instance.
     */
    protected function getMaynardMenu_Menu_MainsitemapService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('maynard_menu.menu.mainsitemap', 'request');
        }

        return $this->services['maynard_menu.menu.mainsitemap'] = $this->scopedServices['request']['maynard_menu.menu.mainsitemap'] = $this->get('maynard_menu.menu_builder')->createMenu($this->get('request'), $this->get('doctrine.orm.default_entity_manager'), 'Main Menu', 'sitemapList side-nav', 'simple');
    }

    /**
     * Gets the 'maynard_menu.menu.smallfooter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Knp\Menu\MenuItem A Knp\Menu\MenuItem instance.
     */
    protected function getMaynardMenu_Menu_SmallfooterService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('maynard_menu.menu.smallfooter', 'request');
        }

        return $this->services['maynard_menu.menu.smallfooter'] = $this->scopedServices['request']['maynard_menu.menu.smallfooter'] = $this->get('maynard_menu.menu_builder')->createMenu($this->get('request'), $this->get('doctrine.orm.default_entity_manager'), 'Small Footer Menu', 'smallfooter-menu menu inline-list', 'simple');
    }

    /**
     * Gets the 'maynard_menu.menu_builder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Maynard\MenuBundle\Menu\MenuBuilder A Maynard\MenuBundle\Menu\MenuBuilder instance.
     */
    protected function getMaynardMenu_MenuBuilderService()
    {
        return $this->services['maynard_menu.menu_builder'] = new \Maynard\MenuBundle\Menu\MenuBuilder($this->get('knp_menu.factory'));
    }

    /**
     * Gets the 'maynard_settings.load_settings' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Maynard\SettingsBundle\Services\LoadSettings A Maynard\SettingsBundle\Services\LoadSettings instance.
     */
    protected function getMaynardSettings_LoadSettingsService()
    {
        return $this->services['maynard_settings.load_settings'] = new \Maynard\SettingsBundle\Services\LoadSettings($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('C:/wamp/www/tgs/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'page.admin.form.type.contentblock' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Maynard\PageBundle\Admin\Form\Type\ContentBlockType A Maynard\PageBundle\Admin\Form\Type\ContentBlockType instance.
     */
    protected function getPage_Admin_Form_Type_ContentblockService()
    {
        return $this->services['page.admin.form.type.contentblock'] = new \Maynard\PageBundle\Admin\Form\Type\ContentBlockType(array('html' => 'Text/HTML', 'image' => 'Image', 'file' => 'File Attachment', 'youtube' => 'YouTube Video', 'slide' => 'Slide', 'vimeo' => 'Vimeo Video', 'contact' => 'Contact Form'), array('large-12' => '100%', 'large-3' => '25%', 'large-4' => '33%', 'large-6' => '50%', 'large-8' => '66%', 'large-9' => '75%'), array('original' => 'Original', 'small' => 'Small', 'medium' => 'Medium', 'big' => 'Big'));
    }

    /**
     * Gets the 'page.admin.form.type.contentblockcollection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Maynard\PageBundle\Admin\Form\Type\ContentBlockCollectionType A Maynard\PageBundle\Admin\Form\Type\ContentBlockCollectionType instance.
     */
    protected function getPage_Admin_Form_Type_ContentblockcollectionService()
    {
        return $this->services['page.admin.form.type.contentblockcollection'] = new \Maynard\PageBundle\Admin\Form\Type\ContentBlockCollectionType();
    }

    /**
     * Gets the 'page.admin.form.type.contentblockcontent' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Maynard\PageBundle\Admin\Form\Type\ContentBlockContentType A Maynard\PageBundle\Admin\Form\Type\ContentBlockContentType instance.
     */
    protected function getPage_Admin_Form_Type_ContentblockcontentService()
    {
        return $this->services['page.admin.form.type.contentblockcontent'] = new \Maynard\PageBundle\Admin\Form\Type\ContentBlockContentType();
    }

    /**
     * Gets the 'page.admin.form.type.contentimage' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Maynard\PageBundle\Admin\Form\Type\ContentImageType A Maynard\PageBundle\Admin\Form\Type\ContentImageType instance.
     */
    protected function getPage_Admin_Form_Type_ContentimageService()
    {
        return $this->services['page.admin.form.type.contentimage'] = new \Maynard\PageBundle\Admin\Form\Type\ContentImageType();
    }

    /**
     * Gets the 'page.admin.form.type.contentimagecollection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Maynard\PageBundle\Admin\Form\Type\ContentImageCollectionType A Maynard\PageBundle\Admin\Form\Type\ContentImageCollectionType instance.
     */
    protected function getPage_Admin_Form_Type_ContentimagecollectionService()
    {
        return $this->services['page.admin.form.type.contentimagecollection'] = new \Maynard\PageBundle\Admin\Form\Type\ContentImageCollectionType();
    }

    /**
     * Gets the 'page.admin.form.type.contentslide' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Maynard\PageBundle\Admin\Form\Type\ContentSlideType A Maynard\PageBundle\Admin\Form\Type\ContentSlideType instance.
     */
    protected function getPage_Admin_Form_Type_ContentslideService()
    {
        return $this->services['page.admin.form.type.contentslide'] = new \Maynard\PageBundle\Admin\Form\Type\ContentSlideType();
    }

    /**
     * Gets the 'page.twig.sort_by_attribute' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Maynard\PageBundle\Twig\SortByAttribute A Maynard\PageBundle\Twig\SortByAttribute instance.
     */
    protected function getPage_Twig_SortByAttributeService()
    {
        return $this->services['page.twig.sort_by_attribute'] = new \Maynard\PageBundle\Twig\SortByAttribute();
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/www/tgs/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    /**
     * Gets the 'recipe.form.productfiltersform' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Maynard\ProductBundle\Form\ProductFiltersFormType A Maynard\ProductBundle\Form\ProductFiltersFormType instance.
     */
    protected function getRecipe_Form_ProductfiltersformService()
    {
        return $this->services['recipe.form.productfiltersform'] = new \Maynard\ProductBundle\Form\ProductFiltersFormType($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'recipe.form.recipefiltersform' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Maynard\RecipeBundle\Form\RecipeFiltersFormType A Maynard\RecipeBundle\Form\RecipeFiltersFormType instance.
     */
    protected function getRecipe_Form_RecipefiltersformService()
    {
        return $this->services['recipe.form.recipefiltersform'] = new \Maynard\RecipeBundle\Form\RecipeFiltersFormType($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'C:/wamp/www/tgs/app/config/routing_dev.yml', array('cache_dir' => 'C:/wamp/www/tgs/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $f->setCacheDir('C:/wamp/www/tgs/app/cache/dev/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/tgs/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('C:/wamp/www/tgs/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/wamp/www/tgs/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/tgs/app/cache/dev/sessions');
    }
    ...
    /**
     * Gets the 'sonata.admin.blogs' service.
     *
     * @return Maynard\BlogBundle\Admin\BlogAdmin A Maynard\BlogBundle\Admin\BlogAdmin instance.
     */
    protected function getSonata_Admin_BlogsService()
    {
        $instance = new \Maynard\BlogBundle\Admin\BlogAdmin('sonata.admin.blogs', 'Maynard\\BlogBundle\\Entity\\Blog', 'BlogBundle:BlogAdmin');

        $instance->setTranslationDomain('BlogBundle');
        ...
        $instance->setLabel('Manage Blog Pages');
    ...
    /**
     * Gets the 'sonata.admin.categories' service.
     *
     * @return Maynard\PageBundle\Admin\CategoriesAdmin A Maynard\PageBundle\Admin\CategoriesAdmin instance.
     */
    protected function getSonata_Admin_CategoriesService()
    {
        $instance = new \Maynard\PageBundle\Admin\CategoriesAdmin('sonata.admin.categories', 'Maynard\\PageBundle\\Entity\\Category', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('PageBundle');
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
        $instance->setFormContractor($this->get('sonata.admin.builder.orm_form'));
        $instance->setShowBuilder($this->get('sonata.admin.builder.orm_show'));
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('Manage Categories');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision' => 'SonataAdminBundle:CRUD:history_revision.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.contentblocks' service.
     *
     * @return Maynard\PageBundle\Admin\ContentBlockAdmin A Maynard\PageBundle\Admin\ContentBlockAdmin instance.
     */
    protected function getSonata_Admin_ContentblocksService()
    {
        $instance = new \Maynard\PageBundle\Admin\ContentBlockAdmin('sonata.admin.contentblocks', 'Maynard\\PageBundle\\Entity\\ContentBlock', 'SonataAdminBundle:CRUD');
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('Manage Content Blocks');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision' => 'SonataAdminBundle:CRUD:history_revision.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.menus' service.
     *
     * @return Maynard\MenuBundle\Admin\MenuAdmin A Maynard\MenuBundle\Admin\MenuAdmin instance.
     */
    protected function getSonata_Admin_MenusService()
    {
        $instance = new \Maynard\MenuBundle\Admin\MenuAdmin('sonata.admin.menus', 'Maynard\\MenuBundle\\Entity\\Menu', 'MenuBundle:MenuAdmin');

        $instance->setTranslationDomain('MenuBundle');
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
        $instance->setFormContractor($this->get('sonata.admin.builder.orm_form'));
        $instance->setShowBuilder($this->get('sonata.admin.builder.orm_show'));
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('Manage Menus');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision' => 'SonataAdminBundle:CRUD:history_revision.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.pages' service.
     *
     * @return Maynard\PageBundle\Admin\PageAdmin A Maynard\PageBundle\Admin\PageAdmin instance.
     */
    protected function getSonata_Admin_PagesService()
    {
        $instance = new \Maynard\PageBundle\Admin\PageAdmin('sonata.admin.pages', 'Maynard\\PageBundle\\Entity\\Page', 'PageBundle:PageAdmin');
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('Manage Website Pages');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision' => 'SonataAdminBundle:CRUD:history_revision.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    {
        $this->services['sonata.admin.pool'] = $instance = new \Sonata\AdminBundle\Admin\Pool($this, 'TGS - Website Admin', '/images/site_assets/adminlogo.jpg', array('html5_validate' => true, 'confirm_exit' => true));
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.pages', 1 => 'sonata.admin.blogs', 2 => 'sonata.admin.recipes', 3 => 'sonata.admin.products', 4 => 'sonata.admin.menus', 5 => 'sonata.admin.categories', 6 => 'sonata.admin.recipecategories', 7 => 'sonata.admin.productcategories', 8 => 'sonata.admin.tags', 9 => 'sonata.admin.recipetags', 10 => 'sonata.admin.producttags', 11 => 'sonata.admin.contentblocks', 12 => 'sonata.admin.settings', 13 => 'sonata.user.admin.user', 14 => 'sonata.user.admin.group', 15 => 'sonata.media.admin.media', 16 => 'sonata.media.admin.gallery', 17 => 'sonata.media.admin.gallery_has_media'));
        $instance->setAdminGroups(array('sonata_pages' => array('label' => 'Website Pages', 'items' => array(0 => 'sonata.admin.pages', 1 => 'sonata.admin.blogs', 2 => 'sonata.admin.recipes', 3 => 'sonata.admin.products'), 'item_adds' => array(), 'label_catalogue' => 'SonataAdminBundle'), 'sonata_menus' => array('label' => 'Menus', 'items' => array(0 => 'sonata.admin.menus'), 'item_adds' => array(), 'label_catalogue' => 'SonataAdminBundle'), 'sonata_categories' => array('label' => 'Categories - Tags', 'items' => array(0 => 'sonata.admin.categories', 1 => 'sonata.admin.recipecategories', 2 => 'sonata.admin.productcategories', 3 => 'sonata.admin.tags', 4 => 'sonata.admin.recipetags', 5 => 'sonata.admin.producttags'), 'item_adds' => array(), 'label_catalogue' => 'SonataAdminBundle'), 'sonata_contentblocks' => array('label' => 'Content Blocks', 'items' => array(0 => 'sonata.admin.contentblocks'), 'item_adds' => array(), 'label_catalogue' => 'SonataAdminBundle'), 'sonata_settings' => array('label' => 'Settings', 'items' => array(0 => 'sonata.admin.settings'), 'item_adds' => array(), 'label_catalogue' => 'SonataAdminBundle'), 'sonata_users' => array('label' => 'Users', 'items' => array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group'), 'item_adds' => array(), 'label_catalogue' => 'SonataAdminBundle'), 'sonata_medias' => array('label' => 'Media', 'items' => array(0 => 'sonata.media.admin.media', 1 => 'sonata.media.admin.gallery'), 'item_adds' => array(), 'label_catalogue' => 'SonataAdminBundle')));
        $instance->setAdminClasses(array('Maynard\\PageBundle\\Entity\\Page' => 'sonata.admin.pages', 'Maynard\\BlogBundle\\Entity\\Blog' => 'sonata.admin.blogs', 'Maynard\\RecipeBundle\\Entity\\Recipe' => 'sonata.admin.recipes', 'Maynard\\ProductBundle\\Entity\\Product' => 'sonata.admin.products', 'Maynard\\MenuBundle\\Entity\\Menu' => 'sonata.admin.menus', 'Maynard\\PageBundle\\Entity\\Category' => 'sonata.admin.categories', 'Maynard\\RecipeBundle\\Entity\\RecipeCategory' => 'sonata.admin.recipecategories', 'Maynard\\ProductBundle\\Entity\\ProductCategory' => 'sonata.admin.productcategories', 'Maynard\\PageBundle\\Entity\\Tag' => 'sonata.admin.tags', 'Maynard\\RecipeBundle\\Entity\\RecipeTag' => 'sonata.admin.recipetags', 'Maynard\\ProductBundle\\Entity\\ProductTag' => 'sonata.admin.producttags', 'Maynard\\PageBundle\\Entity\\ContentBlock' => 'sonata.admin.contentblocks', 'Maynard\\SettingsBundle\\Entity\\Settings' => 'sonata.admin.settings', 'Application\\Sonata\\UserBundle\\Entity\\User' => 'sonata.user.admin.user', 'Application\\Sonata\\UserBundle\\Entity\\Group' => 'sonata.user.admin.group', 'Application\\Sonata\\MediaBundle\\Entity\\Media' => 'sonata.media.admin.media', 'Application\\Sonata\\MediaBundle\\Entity\\Gallery' => 'sonata.media.admin.gallery', 'Application\\Sonata\\MediaBundle\\Entity\\GalleryHasMedia' => 'sonata.media.admin.gallery_has_media'));

        return $instance;
    }

    /**
     * Gets the 'sonata.admin.productcategories' service.
     *
     * @return Maynard\ProductBundle\Admin\ProductCategoriesAdmin A Maynard\ProductBundle\Admin\ProductCategoriesAdmin instance.
     */
    protected function getSonata_Admin_ProductcategoriesService()
    {
        $instance = new \Maynard\ProductBundle\Admin\ProductCategoriesAdmin('sonata.admin.productcategories', 'Maynard\\ProductBundle\\Entity\\ProductCategory', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('ProductBundle');
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
        $instance->setFormContractor($this->get('sonata.admin.builder.orm_form'));
        $instance->setShowBuilder($this->get('sonata.admin.builder.orm_show'));
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('Manage Product Categories');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision' => 'SonataAdminBundle:CRUD:history_revision.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.products' service.
     *
     * @return Maynard\ProductBundle\Admin\ProductAdmin A Maynard\ProductBundle\Admin\ProductAdmin instance.
     */
    protected function getSonata_Admin_ProductsService()
    {
        $instance = new \Maynard\ProductBundle\Admin\ProductAdmin('sonata.admin.products', 'Maynard\\ProductBundle\\Entity\\Product', 'ProductBundle:ProductAdmin');
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('Manage Product Pages');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision' => 'SonataAdminBundle:CRUD:history_revision.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.producttags' service.
     *
     * @return Maynard\ProductBundle\Admin\ProductTagsAdmin A Maynard\ProductBundle\Admin\ProductTagsAdmin instance.
     */
    protected function getSonata_Admin_ProducttagsService()
    {
        $instance = new \Maynard\ProductBundle\Admin\ProductTagsAdmin('sonata.admin.producttags', 'Maynard\\ProductBundle\\Entity\\ProductTag', 'SonataAdminBundle:CRUD');
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('Manage Product Tags');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision' => 'SonataAdminBundle:CRUD:history_revision.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.recipecategories' service.
     *
     * @return Maynard\RecipeBundle\Admin\RecipeCategoriesAdmin A Maynard\RecipeBundle\Admin\RecipeCategoriesAdmin instance.
     */
    protected function getSonata_Admin_RecipecategoriesService()
    {
        $instance = new \Maynard\RecipeBundle\Admin\RecipeCategoriesAdmin('sonata.admin.recipecategories', 'Maynard\\RecipeBundle\\Entity\\RecipeCategory', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('RecipeBundle');
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
        $instance->setFormContractor($this->get('sonata.admin.builder.orm_form'));
        $instance->setShowBuilder($this->get('sonata.admin.builder.orm_show'));
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('Manage Recipe Categories');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision' => 'SonataAdminBundle:CRUD:history_revision.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.recipes' service.
     *
     * @return Maynard\RecipeBundle\Admin\RecipeAdmin A Maynard\RecipeBundle\Admin\RecipeAdmin instance.
     */
    protected function getSonata_Admin_RecipesService()
    {
        $instance = new \Maynard\RecipeBundle\Admin\RecipeAdmin('sonata.admin.recipes', 'Maynard\\RecipeBundle\\Entity\\Recipe', 'RecipeBundle:RecipeAdmin');
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('Manage Recipe Pages');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision' => 'SonataAdminBundle:CRUD:history_revision.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    /**
     * Gets the 'sonata.admin.recipetags' service.
     *
     * @return Maynard\RecipeBundle\Admin\RecipeTagsAdmin A Maynard\RecipeBundle\Admin\RecipeTagsAdmin instance.
     */
    protected function getSonata_Admin_RecipetagsService()
    {
        $instance = new \Maynard\RecipeBundle\Admin\RecipeTagsAdmin('sonata.admin.recipetags', 'Maynard\\RecipeBundle\\Entity\\RecipeTag', 'SonataAdminBundle:CRUD');
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('Manage Recipe Tags');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision' => 'SonataAdminBundle:CRUD:history_revision.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.pages', 1 => 'sonata.admin.blogs', 2 => 'sonata.admin.recipes', 3 => 'sonata.admin.products', 4 => 'sonata.admin.menus', 5 => 'sonata.admin.categories', 6 => 'sonata.admin.recipecategories', 7 => 'sonata.admin.productcategories', 8 => 'sonata.admin.tags', 9 => 'sonata.admin.recipetags', 10 => 'sonata.admin.producttags', 11 => 'sonata.admin.contentblocks', 12 => 'sonata.admin.settings', 13 => 'sonata.user.admin.user', 14 => 'sonata.user.admin.group', 15 => 'sonata.media.admin.media', 16 => 'sonata.media.admin.gallery', 17 => 'sonata.media.admin.gallery_has_media'), $this);
    }
    ...
    /**
     * Gets the 'sonata.admin.settings' service.
     *
     * @return Maynard\SettingsBundle\Admin\SettingsAdmin A Maynard\SettingsBundle\Admin\SettingsAdmin instance.
     */
    protected function getSonata_Admin_SettingsService()
    {
        $instance = new \Maynard\SettingsBundle\Admin\SettingsAdmin('sonata.admin.settings', 'Maynard\\SettingsBundle\\Entity\\Settings', 'SettingsBundle:SettingsAdmin');

        $instance->setTranslationDomain('SettingsBundle');
        $instance->setManagerType('orm');
        $instance->setModelManager($this->get('sonata.admin.manager.orm'));
        $instance->setFormContractor($this->get('sonata.admin.builder.orm_form'));
        $instance->setShowBuilder($this->get('sonata.admin.builder.orm_show'));
        ...
        $instance->setRouteBuilder($this->get('sonata.admin.route.path_info'));
        $instance->setLabelTranslatorStrategy($this->get('sonata.admin.label.strategy.native'));
        $instance->setLabel('Manage Website Settings');
        $instance->setPersistFilters(false);
        $instance->setTemplates(array('user_block' => 'SonataUserBundle:Admin/Core:user_block.html.twig', 'layout' => 'SonataAdminBundle::standard_layout.html.twig', 'ajax' => 'SonataAdminBundle::ajax_layout.html.twig', 'dashboard' => 'SonataAdminBundle:Core:dashboard.html.twig', 'list' => 'SonataAdminBundle:CRUD:list.html.twig', 'show' => 'SonataAdminBundle:CRUD:show.html.twig', 'edit' => 'SonataAdminBundle:CRUD:edit.html.twig', 'history' => 'SonataAdminBundle:CRUD:history.html.twig', 'history_revision' => 'SonataAdminBundle:CRUD:history_revision.html.twig', 'acl' => 'SonataAdminBundle:CRUD:acl.html.twig', 'action' => 'SonataAdminBundle:CRUD:action.html.twig', 'short_object_description' => 'SonataAdminBundle:Helper:short-object-description.html.twig', 'preview' => 'SonataAdminBundle:CRUD:preview.html.twig', 'list_block' => 'SonataAdminBundle:Block:block_admin_list.html.twig', 'delete' => 'SonataAdminBundle:CRUD:delete.html.twig', 'batch' => 'SonataAdminBundle:CRUD:list__batch.html.twig', 'select' => 'SonataAdminBundle:CRUD:list__select.html.twig', 'batch_confirmation' => 'SonataAdminBundle:CRUD:batch_confirmation.html.twig', 'inner_list_row' => 'SonataAdminBundle:CRUD:list_inner_row.html.twig', 'base_list_field' => 'SonataAdminBundle:CRUD:base_list_field.html.twig', 'pager_links' => 'SonataAdminBundle:Pager:links.html.twig', 'pager_results' => 'SonataAdminBundle:Pager:results.html.twig'));
        $instance->setSecurityInformation(array('EDIT' => array(0 => 'EDIT'), 'LIST' => array(0 => 'LIST'), 'CREATE' => array(0 => 'CREATE'), 'VIEW' => array(0 => 'VIEW'), 'DELETE' => array(0 => 'DELETE'), 'OPERATOR' => array(0 => 'OPERATOR'), 'MASTER' => array(0 => 'MASTER')));
        $instance->initialize();
     ...
     *
     * @return Maynard\PageBundle\Admin\TagsAdmin A Maynard\PageBundle\Admin\TagsAdmin instance.
     */
    protected function getSonata_Admin_TagsService()
    {
        $instance = new \Maynard\PageBundle\Admin\TagsAdmin('sonata.admin.tags', 'Maynard\\PageBundle\\Entity\\Tag', 'SonataAdminBundle:CRUD');
    ...
    {
        return $this->services['sonata.block.context_manager.default'] = new \Sonata\BlockBundle\Block\BlockContextManager($this->get('sonata.block.loader.chain'), $this->get('sonata.block.manager'), array('by_type' => array('sonata.admin.block.admin_list' => 'sonata.cache.noop', 'sonata.block.service.text' => 'sonata.cache.noop', 'sonata.block.service.action' => 'sonata.cache.noop', 'sonata.block.service.rss' => 'sonata.cache.noop', 'sonata.media.block.media' => 'sonata.cache.noop', 'sonata.admin.pages' => 'sonata.cache.noop', 'sonata.admin.menus' => 'sonata.cache.noop', 'sonata.admin.blogs' => 'sonata.cache.noop', 'sonata.admin.recipies' => 'sonata.cache.noop', 'sonata.admin.products' => 'sonata.cache.noop', 'sonata.admin.categories' => 'sonata.cache.noop', 'sonata.admin.tags' => 'sonata.cache.noop', 'sonata.admin.recipecategories' => 'sonata.cache.noop', 'sonata.admin.recipetags' => 'sonata.cache.noop', 'sonata.admin.productcategories' => 'sonata.cache.noop', 'sonata.admin.producttags' => 'sonata.cache.noop', 'sonata.admin.contentblocks' => 'sonata.cache.noop', 'sonata.user.admin.user' => 'sonata.cache.noop', 'sonata.admin.settings' => 'sonata.cache.noop')));
    }
    ...
    {
        return $this->services['sonata.block.form.type.block'] = new \Sonata\BlockBundle\Form\Type\ServiceListType($this->get('sonata.block.manager'), array('admin' => array(0 => 'sonata.admin.block.admin_list'), 'cms' => array(0 => 'sonata.block.service.text', 1 => 'sonata.block.service.action', 2 => 'sonata.block.service.rss', 3 => 'sonata.media.block.media', 4 => 'sonata.admin.pages', 5 => 'sonata.admin.menus', 6 => 'sonata.admin.blogs', 7 => 'sonata.admin.recipies', 8 => 'sonata.admin.products', 9 => 'sonata.admin.categories', 10 => 'sonata.admin.tags', 11 => 'sonata.admin.recipecategories', 12 => 'sonata.admin.recipetags', 13 => 'sonata.admin.productcategories', 14 => 'sonata.admin.producttags', 15 => 'sonata.admin.contentblocks', 16 => 'sonata.user.admin.user', 17 => 'sonata.admin.settings')));
    }
    ...
    {
        return $this->services['sonata.block.loader.service'] = new \Sonata\BlockBundle\Block\Loader\ServiceLoader(array(0 => 'sonata.admin.block.admin_list', 1 => 'sonata.block.service.text', 2 => 'sonata.block.service.action', 3 => 'sonata.block.service.rss', 4 => 'sonata.media.block.media', 5 => 'sonata.admin.pages', 6 => 'sonata.admin.menus', 7 => 'sonata.admin.blogs', 8 => 'sonata.admin.recipies', 9 => 'sonata.admin.products', 10 => 'sonata.admin.categories', 11 => 'sonata.admin.tags', 12 => 'sonata.admin.recipecategories', 13 => 'sonata.admin.recipetags', 14 => 'sonata.admin.productcategories', 15 => 'sonata.admin.producttags', 16 => 'sonata.admin.contentblocks', 17 => 'sonata.user.admin.user', 18 => 'sonata.admin.settings'));
    }
    ...
    {
        return $this->services['sonata.media.adapter.filesystem.local'] = new \Sonata\MediaBundle\Filesystem\Local('C:/wamp/www/tgs/app/../web/uploads/media', false);
    }
    ...
    protected function getSonata_Media_PoolService()
    {
        ...
        $instance->addContext('default', array(0 => 'sonata.media.provider.youtube', 1 => 'sonata.media.provider.vimeo', 2 => 'sonata.media.provider.image', 3 => 'sonata.media.provider.file'), array('default_small' => array('width' => 213, 'height' => 254, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'default_medium' => array('width' => 452, 'height' => 254, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'default_big' => array('width' => 470, 'height' => 318, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'default_original' => array('quality' => 100, 'width' => false, 'height' => false, 'format' => 'jpg', 'constraint' => true)), array('strategy' => 'sonata.media.security.superadmin_strategy', 'mode' => 'http'));
        $instance->addContext('intro', array(0 => 'sonata.media.provider.youtube', 1 => 'sonata.media.provider.image'), array('intro_small' => array('width' => 213, 'height' => 254, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'intro_blog' => array('width' => 227, 'height' => 205, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'intro_medium' => array('width' => 452, 'height' => 254, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'intro_big' => array('width' => 470, 'height' => 318, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'intro_original' => array('quality' => 100, 'width' => false, 'height' => false, 'format' => 'jpg', 'constraint' => true)), array('strategy' => 'sonata.media.security.superadmin_strategy', 'mode' => 'http'));
        $instance->addContext('bgimage', array(0 => 'sonata.media.provider.image'), array('bgimage_small' => array('width' => 224, 'height' => 206, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'bgimage_mobile' => array('width' => 768, 'height' => 300, 'quality' => 80, 'format' => 'jpg', 'constraint' => true), 'bgimage_medium' => array('width' => 310, 'height' => 318, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'bgimage_big' => array('width' => 1388, 'height' => 257, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'bgimage_slide' => array('width' => 1388, 'height' => 394, 'quality' => 80, 'format' => 'jpg', 'constraint' => true), 'bgimage_original' => array('quality' => 100, 'width' => false, 'height' => false, 'format' => 'jpg', 'constraint' => true)), array('strategy' => 'sonata.media.security.superadmin_strategy', 'mode' => 'http'));
        $instance->addContext('recipe', array(0 => 'sonata.media.provider.image'), array('recipe_xsmall' => array('width' => 191, 'height' => 176, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'recipe_small' => array('width' => 224, 'height' => 206, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'recipe_medium' => array('width' => 310, 'height' => 318, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'recipe_big' => array('width' => 307, 'height' => 356, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'recipe_original' => array('quality' => 100, 'width' => false, 'height' => false, 'format' => 'jpg', 'constraint' => true)), array('strategy' => 'sonata.media.security.superadmin_strategy', 'mode' => 'http'));
        $instance->addContext('product', array(0 => 'sonata.media.provider.image'), array('product_xsmall' => array('width' => 66, 'height' => 112, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'product_small' => array('width' => 152, 'height' => 260, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'product_medium' => array('width' => 226, 'height' => 385, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'product_big' => array('width' => 306, 'height' => 522, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'product_original' => array('quality' => 100, 'width' => false, 'height' => false, 'format' => 'jpg', 'constraint' => true)), array('strategy' => 'sonata.media.security.superadmin_strategy', 'mode' => 'http'));
        $instance->addContext('productlist', array(0 => 'sonata.media.provider.image'), array('productlist_small' => array('width' => 226, 'height' => 260, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'productlist_medium' => array('width' => 226, 'height' => 260, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'productlist_big' => array('width' => 226, 'height' => 260, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'productlist_original' => array('quality' => 100, 'width' => false, 'height' => false, 'format' => 'jpg', 'constraint' => true)), array('strategy' => 'sonata.media.security.superadmin_strategy', 'mode' => 'http'));
        $instance->addContext('icons', array(0 => 'sonata.media.provider.image'), array('icons_small' => array('width' => 46, 'height' => 46, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'icons_medium' => array('width' => 66, 'height' => 66, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'icons_big' => array('width' => 86, 'height' => 86, 'quality' => 100, 'format' => 'jpg', 'constraint' => true), 'icons_original' => array('quality' => 100, 'width' => false, 'height' => false, 'format' => 'jpg', 'constraint' => true)), array('strategy' => 'sonata.media.security.superadmin_strategy', 'mode' => 'http'));
    ...
    protected function getSonata_Media_Provider_FileService()
    {
        ...
        $instance->addFormat('default_small', array('width' => 213, 'height' => 254, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('default_medium', array('width' => 452, 'height' => 254, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('default_big', array('width' => 470, 'height' => 318, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('default_original', array('quality' => 100, 'width' => false, 'height' => false, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('admin', array('quality' => 80, 'width' => 100, 'format' => 'jpg', 'height' => false, 'constraint' => true));
    ...
    protected function getSonata_Media_Provider_ImageService()
    {
        ...
        $instance->addFormat('default_big', array('width' => 470, 'height' => 318, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('default_original', array('quality' => 100, 'width' => false, 'height' => false, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('intro_small', array('width' => 213, 'height' => 254, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('intro_blog', array('width' => 227, 'height' => 205, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('intro_medium', array('width' => 452, 'height' => 254, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('intro_big', array('width' => 470, 'height' => 318, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('intro_original', array('quality' => 100, 'width' => false, 'height' => false, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('bgimage_small', array('width' => 224, 'height' => 206, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('bgimage_mobile', array('width' => 768, 'height' => 300, 'quality' => 80, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('bgimage_medium', array('width' => 310, 'height' => 318, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('bgimage_big', array('width' => 1388, 'height' => 257, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('bgimage_slide', array('width' => 1388, 'height' => 394, 'quality' => 80, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('bgimage_original', array('quality' => 100, 'width' => false, 'height' => false, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('recipe_xsmall', array('width' => 191, 'height' => 176, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('recipe_small', array('width' => 224, 'height' => 206, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('recipe_medium', array('width' => 310, 'height' => 318, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('recipe_big', array('width' => 307, 'height' => 356, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('recipe_original', array('quality' => 100, 'width' => false, 'height' => false, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('product_xsmall', array('width' => 66, 'height' => 112, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('product_small', array('width' => 152, 'height' => 260, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('product_medium', array('width' => 226, 'height' => 385, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('product_big', array('width' => 306, 'height' => 522, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('product_original', array('quality' => 100, 'width' => false, 'height' => false, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('productlist_small', array('width' => 226, 'height' => 260, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('productlist_medium', array('width' => 226, 'height' => 260, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('productlist_big', array('width' => 226, 'height' => 260, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('productlist_original', array('quality' => 100, 'width' => false, 'height' => false, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('icons_small', array('width' => 46, 'height' => 46, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('icons_medium', array('width' => 66, 'height' => 66, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('icons_big', array('width' => 86, 'height' => 86, 'quality' => 100, 'format' => 'jpg', 'constraint' => true));
        $instance->addFormat('icons_original', array('quality' => 100, 'width' => false, 'height' => false, 'format' => 'jpg', 'constraint' => true));
        $instance->setResizer($this->get('sonata.media.resizer.maynard'));
        $instance->addFormat('admin', array('quality' => 80, 'width' => 100, 'format' => 'jpg', 'height' => false, 'constraint' => true));
    ...
    /**
     * Gets the 'sonata.media.resizer.maynard' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Maynard\PageBundle\Media\Resizer\MaynardResizer A Maynard\PageBundle\Media\Resizer\MaynardResizer instance.
     */
    protected function getSonata_Media_Resizer_MaynardService()
    {
        return $this->services['sonata.media.resizer.maynard'] = new \Maynard\PageBundle\Media\Resizer\MaynardResizer($this->get('sonata.media.adapter.image.gd'));
    }
     ...
     *
     * @return Application\Sonata\UserBundle\Admin\Entity\MMUserAdmin A Application\Sonata\UserBundle\Admin\Entity\MMUserAdmin instance.
     */
    protected function getSonata_User_Admin_UserService()
    {
        $instance = new \Application\Sonata\UserBundle\Admin\Entity\MMUserAdmin('sonata.user.admin.user', 'Application\\Sonata\\UserBundle\\Entity\\User', 'SonataAdminBundle:CRUD');
    ...
    /**
     * Gets the 'sonata_user.form.type.registration' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Application\Sonata\UserBundle\Form\Type\RegistrationFormType A Application\Sonata\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getSonataUser_Form_Type_RegistrationService()
    {
        return $this->services['sonata_user.form.type.registration'] = new \Application\Sonata\UserBundle\Form\Type\RegistrationFormType('Application\\Sonata\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/wamp/www/tgs/app', 'UTF-8');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'C:/wamp/www/tgs/app/cache/dev/translations', 'debug' => true));

        $instance->setFallbackLocale('en');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.af.xlf', 'af', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ar.xlf', 'ar', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.bg.xlf', 'bg', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ca.xlf', 'ca', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cs.xlf', 'cs', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.cy.xlf', 'cy', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.da.xlf', 'da', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.de.xlf', 'de', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.en.xlf', 'en', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.es.xlf', 'es', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.et.xlf', 'et', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.eu.xlf', 'eu', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fa.xlf', 'fa', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fi.xlf', 'fi', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.fr.xlf', 'fr', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.gl.xlf', 'gl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.he.xlf', 'he', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hr.xlf', 'hr', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hu.xlf', 'hu', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.hy.xlf', 'hy', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.id.xlf', 'id', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.it.xlf', 'it', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ja.xlf', 'ja', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lb.xlf', 'lb', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.lt.xlf', 'lt', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.mn.xlf', 'mn', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nb.xlf', 'nb', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.nl.xlf', 'nl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.no.xlf', 'no', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pl.xlf', 'pl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt.xlf', 'pt', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.pt_BR.xlf', 'pt_BR', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ro.xlf', 'ro', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.ru.xlf', 'ru', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sk.xlf', 'sk', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sl.xlf', 'sl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sq.xlf', 'sq', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Cyrl.xlf', 'sr_Cyrl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sr_Latn.xlf', 'sr_Latn', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.sv.xlf', 'sv', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.tr.xlf', 'tr', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.uk.xlf', 'uk', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Validator/Resources/translations\\validators.zh_CN.xlf', 'zh_CN', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ar.xlf', 'ar', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.bg.xlf', 'bg', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ca.xlf', 'ca', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.cs.xlf', 'cs', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.da.xlf', 'da', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.de.xlf', 'de', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.el.xlf', 'el', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.en.xlf', 'en', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.es.xlf', 'es', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.et.xlf', 'et', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.eu.xlf', 'eu', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fa.xlf', 'fa', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fi.xlf', 'fi', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.fr.xlf', 'fr', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.gl.xlf', 'gl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.he.xlf', 'he', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hr.xlf', 'hr', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hu.xlf', 'hu', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.hy.xlf', 'hy', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.id.xlf', 'id', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.it.xlf', 'it', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ja.xlf', 'ja', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lb.xlf', 'lb', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lt.xlf', 'lt', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.lv.xlf', 'lv', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.mn.xlf', 'mn', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nb.xlf', 'nb', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.nl.xlf', 'nl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pl.xlf', 'pl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt.xlf', 'pt', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.pt_BR.xlf', 'pt_BR', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ro.xlf', 'ro', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ru.xlf', 'ru', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sk.xlf', 'sk', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sl.xlf', 'sl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Cyrl.xlf', 'sr_Cyrl', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sr_Latn.xlf', 'sr_Latn', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.sv.xlf', 'sv', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.ua.xlf', 'ua', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/translations\\validators.zh_CN.xlf', 'zh_CN', 'validators');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.ar.xlf', 'ar', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.ca.xlf', 'ca', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.cs.xlf', 'cs', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.da.xlf', 'da', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.de.xlf', 'de', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.en.xlf', 'en', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.es.xlf', 'es', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.fa.xlf', 'fa', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.fr.xlf', 'fr', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.gl.xlf', 'gl', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.hu.xlf', 'hu', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.it.xlf', 'it', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.lb.xlf', 'lb', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.nl.xlf', 'nl', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.no.xlf', 'no', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.pl.xlf', 'pl', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.pt_BR.xlf', 'pt_BR', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.pt_PT.xlf', 'pt_PT', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.ro.xlf', 'ro', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.ru.xlf', 'ru', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.sk.xlf', 'sk', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.sl.xlf', 'sl', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.sr_Cyrl.xlf', 'sr_Cyrl', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.sr_Latn.xlf', 'sr_Latn', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.sv.xlf', 'sv', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.tr.xlf', 'tr', 'security');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Security\\Core\\Exception/../../Resources/translations\\security.ua.xlf', 'ua', 'security');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.bg.yml', 'bg', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ca.yml', 'ca', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.cs.yml', 'cs', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.da.yml', 'da', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.de.yml', 'de', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.en.yml', 'en', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.es.yml', 'es', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.et.yml', 'et', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.fa.yml', 'fa', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.fi.yml', 'fi', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.fr.yml', 'fr', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.hr.yml', 'hr', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.hu.yml', 'hu', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.it.yml', 'it', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ja.yml', 'ja', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.lb.yml', 'lb', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.lt.yml', 'lt', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.lv.yml', 'lv', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.nl.yml', 'nl', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.pl.yml', 'pl', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.pt_BR.yml', 'pt_BR', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.pt_PT.yml', 'pt_PT', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ro.yml', 'ro', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.ru.yml', 'ru', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sk.yml', 'sk', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sl.yml', 'sl', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sr_Latn.yml', 'sr_Latn', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.sv.yml', 'sv', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.tr.yml', 'tr', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.uk.yml', 'uk', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\FOSUserBundle.zh_CN.yml', 'zh_CN', 'FOSUserBundle');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.bg.yml', 'bg', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.cs.yml', 'cs', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.da.yml', 'da', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.de.yml', 'de', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.en.yml', 'en', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.es.yml', 'es', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.fa.yml', 'fa', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.fi.yml', 'fi', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.fr.yml', 'fr', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.hr.yml', 'hr', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.hu.yml', 'hu', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.it.yml', 'it', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.ja.yml', 'ja', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.lt.yml', 'lt', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.lv.yml', 'lv', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.nl.yml', 'nl', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.pl.yml', 'pl', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.pt.yml', 'pt', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.pt_BR.yml', 'pt_BR', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.ru.yml', 'ru', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sk.yml', 'sk', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sl.yml', 'sl', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sr_Latn.yml', 'sr_Latn', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.sv.yml', 'sv', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.tr.yml', 'tr', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.uk.yml', 'uk', 'validators');
        $instance->addResource('yml', 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/translations\\validators.zh_CN.yml', 'zh_CN', 'validators');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.bg.xliff', 'bg', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.ca.xliff', 'ca', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.cs.xliff', 'cs', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.de.xliff', 'de', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.en.xliff', 'en', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.es.xliff', 'es', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.eu.xliff', 'eu', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.fa.xliff', 'fa', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.fr.xliff', 'fr', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.hr.xliff', 'hr', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.hu.xliff', 'hu', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.it.xliff', 'it', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.ja.xliff', 'ja', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.lb.xliff', 'lb', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.nl.xliff', 'nl', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.pl.xliff', 'pl', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.pt.xliff', 'pt', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.pt_BR.xliff', 'pt_BR', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.ro.xliff', 'ro', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.ru.xliff', 'ru', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.sk.xliff', 'sk', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.sl.xliff', 'sl', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.uk.xliff', 'uk', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/translations\\SonataAdminBundle.zh_CN.xliff', 'zh_CN', 'SonataAdminBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.bg.xliff', 'bg', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.ca.xliff', 'ca', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.cs.xliff', 'cs', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.de.xliff', 'de', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.en.xliff', 'en', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.es.xliff', 'es', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.fa.xliff', 'fa', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.fr.xliff', 'fr', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.it.xliff', 'it', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.nl.xliff', 'nl', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.pl.xliff', 'pl', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.pt.xliff', 'pt', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.ru.xliff', 'ru', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.sk.xliff', 'sk', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.sl.xliff', 'sl', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/translations\\SonataUserBundle.zh_TW.xliff', 'zh_TW', 'SonataUserBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\media-bundle\\Sonata\\MediaBundle/Resources/translations\\SonataMediaBundle.de.xliff', 'de', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\media-bundle\\Sonata\\MediaBundle/Resources/translations\\SonataMediaBundle.en.xliff', 'en', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\media-bundle\\Sonata\\MediaBundle/Resources/translations\\SonataMediaBundle.es.xliff', 'es', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\media-bundle\\Sonata\\MediaBundle/Resources/translations\\SonataMediaBundle.fr.xliff', 'fr', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\media-bundle\\Sonata\\MediaBundle/Resources/translations\\SonataMediaBundle.lt.xliff', 'lt', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\media-bundle\\Sonata\\MediaBundle/Resources/translations\\SonataMediaBundle.nl.xliff', 'nl', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\media-bundle\\Sonata\\MediaBundle/Resources/translations\\SonataMediaBundle.pl.xliff', 'pl', 'SonataMediaBundle');
        $instance->addResource('xliff', 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\media-bundle\\Sonata\\MediaBundle/Resources/translations\\SonataMediaBundle.sl.xliff', 'sl', 'SonataMediaBundle');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\src\\Maynard\\SettingsBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\src\\Maynard\\MenuBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\src\\Maynard\\PageBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\src\\Maynard\\BlogBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\src\\Maynard\\RecipeBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
        $instance->addResource('xlf', 'C:\\wamp\\www\\tgs\\src\\Maynard\\ProductBundle/Resources/translations\\messages.fr.xlf', 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => 'C:/wamp/www/tgs/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/wamp/www/tgs/app', 'UTF-8'));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\RoutingExtension($this->get('router')));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\YamlExtension());
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\HttpKernelExtension($this->get('fragment.handler')));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'PageBundle:Form:fields.html.twig', 2 => 'SonataUserBundle:Form:form_admin_fields.html.twig')), $this->get('form.csrf_provider'))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'PageBundle', 1 => 'BlogBundle', 2 => 'RecipeBundle', 3 => 'ProductBundle', 4 => 'FOSUserBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        ...
        $instance->addExtension($this->get('page.twig.sort_by_attribute'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:/wamp/www/tgs/app/Resources/FOSUserBundle/views', 'FOSUser');
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views', 'FOSUser');
        $instance->addPath('C:/wamp/www/tgs/app/Resources/SonataAdminBundle/views', 'SonataAdmin');
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\sonata-project\\admin-bundle\\Sonata\\AdminBundle/Resources/views', 'SonataAdmin');
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\sonata-project\\block-bundle\\Sonata\\BlockBundle/Resources/views', 'SonataBlock');
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\sonata-project\\doctrine-orm-admin-bundle\\Sonata\\DoctrineORMAdminBundle/Resources/views', 'SonataDoctrineORMAdmin');
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\sonata-project\\user-bundle\\Sonata\\UserBundle/Resources/views', 'SonataUser');
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\stfalcon\\tinymce-bundle\\Stfalcon\\Bundle\\TinymceBundle/Resources/views', 'StfalconTinymce');
        $instance->addPath('C:/wamp/www/tgs/app/Resources/SonataMediaBundle/views', 'SonataMedia');
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\sonata-project\\media-bundle\\Sonata\\MediaBundle/Resources/views', 'SonataMedia');
        $instance->addPath('C:\\wamp\\www\\tgs\\src\\Maynard\\SettingsBundle/Resources/views', 'Settings');
        $instance->addPath('C:\\wamp\\www\\tgs\\src\\Maynard\\MenuBundle/Resources/views', 'Menu');
        $instance->addPath('C:\\wamp\\www\\tgs\\src\\Maynard\\PageBundle/Resources/views', 'Page');
        $instance->addPath('C:\\wamp\\www\\tgs\\src\\Maynard\\BlogBundle/Resources/views', 'Blog');
        $instance->addPath('C:\\wamp\\www\\tgs\\src\\Maynard\\RecipeBundle/Resources/views', 'Recipe');
        $instance->addPath('C:\\wamp\\www\\tgs\\src\\Maynard\\ProductBundle/Resources/views', 'Product');
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('C:/wamp/www/tgs/app/Resources/views');
        $instance->addPath('C:\\wamp\\www\\tgs\\vendor\\knplabs\\knp-menu\\src\\Knp\\Menu/Resources/views');
     ...
     *
     * @return EntityManager520ed5c38b532_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    /**
     * Gets the sensio.distribution.webconfigurator service alias.
     *
     * @return Sensio\Bundle\DistributionBundle\Configurator\Configurator An instance of the sensio_distribution.webconfigurator service
     */
    protected function getSensio_Distribution_WebconfiguratorService()
    {
        return $this->get('sensio_distribution.webconfigurator');
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/wamp/www/tgs/app/../web', true);

        $instance->addWorker(new \Assetic\Factory\Worker\EnsureFilterWorker('/\\.scss$/', $this->get('assetic.filter.compass')));
    ...
    {
        return $this->services['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener($this->get('security.context'), array(0 => $this->get('security.user.provider.concrete.in_memory'), 1 => $this->get('fos_user.user_manager')), 'user', $this->get('monolog.logger.security'), $this->get('event_dispatcher'));
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('C:/wamp/www/tgs/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/tgs/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml', 1 => 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml', 2 => 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\media-bundle\\Sonata\\MediaBundle\\Resources\\config\\validation.xml', 3 => 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/wamp/www/tgs/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/wamp/www/tgs/app/cache/dev',
            'kernel.logs_dir' => 'C:/wamp/www/tgs/app/logs',
            'kernel.bundles' => array(
                ...
                'SettingsBundle' => 'Maynard\\SettingsBundle\\SettingsBundle',
                'MenuBundle' => 'Maynard\\MenuBundle\\MenuBundle',
                'PageBundle' => 'Maynard\\PageBundle\\PageBundle',
                'BlogBundle' => 'Maynard\\BlogBundle\\BlogBundle',
                'RecipeBundle' => 'Maynard\\RecipeBundle\\RecipeBundle',
                'ProductBundle' => 'Maynard\\ProductBundle\\ProductBundle',
            ...
            'compass.bin' => 'C:\\Program Files (x86)\\Ruby193\\bin\\compass',
            'sass.bin' => 'C:\\Program Files (x86)\\Ruby193\\bin\\sass',
            'unix_socket' => NULL,
            'assetic.filter.compass.images_dir' => 'C:/wamp/www/tgs/app/../web/images',
            ...
            'debug.container.dump' => 'C:/wamp/www/tgs/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/wamp/www/tgs/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\wamp\\www\\tgs\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
                1 => 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation.xml',
                2 => 'C:\\wamp\\www\\tgs\\vendor\\sonata-project\\media-bundle\\Sonata\\MediaBundle\\Resources\\config\\validation.xml',
                3 => 'C:\\wamp\\www\\tgs\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\validation\\orm.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/www/tgs/app/cache/dev/profiler',
            ...
            'router.resource' => 'C:/wamp/www/tgs/app/config/routing_dev.yml',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'PageBundle:Form:fields.html.twig',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/tgs/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/tgs/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/tgs/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'C:/wamp/www/tgs/app/../web',
            'assetic.write_to' => 'C:/wamp/www/tgs/app/../web',
            'assetic.variables' => array(

            ),
            'assetic.java.bin' => 'C:\\Program Files (x86)\\Java\\jre6\\bin\\java.exe',
            'assetic.node.bin' => 'c:\\Program Files\\nodejs\\\\node.EXE',
            'assetic.ruby.bin' => 'c:\\Program Files (x86)\\Ruby193\\bin\\ruby.EXE',
            'assetic.sass.bin' => 'c:\\Program Files (x86)\\Ruby193\\bin\\sass.BAT',
            'assetic.filter.cssrewrite.class' => 'Assetic\\Filter\\CssRewriteFilter',
            'assetic.filter.sass.class' => 'Assetic\\Filter\\Sass\\SassFilter',
            'assetic.filter.sass.bin' => 'C:\\Program Files (x86)\\Ruby193\\bin\\sass',
            ...
            'assetic.filter.compass.bin' => 'C:\\Program Files (x86)\\Ruby193\\bin\\compass',
            ...
            'assetic.filter.scss.sass' => 'c:\\Program Files (x86)\\Ruby193\\bin\\sass.BAT',
            ...
            'assetic.filter.yui_css.jar' => 'C:/wamp/www/tgs/app/Resources/java/yuicompressor.jar',
            ...
            'assetic.filter.yui_js.jar' => 'C:/wamp/www/tgs/app/Resources/java/yuicompressor.jar',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/tgs/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'C:/wamp/www/tgs/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'C:/wamp/www/tgs/app/cache/dev/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'C:/wamp/www/tgs/app/cache/dev/jms_diextra/doctrine/EntityManager_520ed5c38b532.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager520ed5c38b532_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'C:/wamp/www/tgs/app/cache/dev/jms_security',
            ...
            'fos_user.registration.confirmation.template' => 'FOSUserBundle:Registration:confirm_email.txt.twig',
            ...
            'sonata.admin.configuration.dashboard_groups' => array(
                'sonata_pages' => array(
                    'label' => 'Website Pages',
                    'items' => array(
                        0 => 'sonata.admin.pages',
                        1 => 'sonata.admin.blogs',
                        2 => 'sonata.admin.recipes',
                        3 => 'sonata.admin.products',
                    ),
                    'item_adds' => array(
                ...
                'sonata_menus' => array(
                    'label' => 'Menus',
                    'items' => array(
                        0 => 'sonata.admin.menus',
                    ),
                    'item_adds' => array(

                    ),
                ),
                'sonata_categories' => array(
                    'label' => 'Categories - Tags',
                    'items' => array(
                        0 => 'sonata.admin.categories',
                        1 => 'sonata.admin.recipecategories',
                        2 => 'sonata.admin.productcategories',
                        3 => 'sonata.admin.tags',
                        4 => 'sonata.admin.recipetags',
                        5 => 'sonata.admin.producttags',
                    ),
                    'item_adds' => array(

                    ),
                ),
                'sonata_contentblocks' => array(
                    'label' => 'Content Blocks',
                    'items' => array(
                        0 => 'sonata.admin.contentblocks',
                    ),
                    'item_adds' => array(

                    ),
                ),
                'sonata_settings' => array(
                    'label' => 'Settings',
                    'items' => array(
                        0 => 'sonata.admin.settings',
                    ),
                    'item_adds' => array(
                ...
                'sonata_medias' => array(
                    'label' => 'Media',
                    'items' => array(
                        0 => 'sonata.media.admin.media',
                        1 => 'sonata.media.admin.gallery',
                    ),
                    'item_adds' => array(
            ...
            'sonata_block.blocks' => array(
                ...
                'sonata.admin.recipecategories' => array(
                    'contexts' => array(
                ...
                'sonata.admin.productcategories' => array(
                    'contexts' => array(
                ...
                'sonata.admin.producttags' => array(
                    'contexts' => array(
                ...
                'sonata.admin.contentblocks' => array(
                    'contexts' => array(
            ...
            'sonata_block.cache_blocks' => array(
                'by_type' => array(
                    ...
                    'sonata.admin.recipies' => 'sonata.cache.noop',
                    'sonata.admin.products' => 'sonata.cache.noop',
                    'sonata.admin.categories' => 'sonata.cache.noop',
                    'sonata.admin.tags' => 'sonata.cache.noop',
                    'sonata.admin.recipecategories' => 'sonata.cache.noop',
                    'sonata.admin.recipetags' => 'sonata.cache.noop',
                    'sonata.admin.productcategories' => 'sonata.cache.noop',
            ...
            'sonata.user.admin.user.class' => 'Application\\Sonata\\UserBundle\\Admin\\Entity\\MMUserAdmin',
            ...
            'stfalcon_tinymce.config' => array(
                ...
                'theme' => array(
                    ...
                    'advanced' => array(
                        ...
                        'height' => '340',
                        'plugins' => array(
                            0 => 'pagebreak layer table save autosave insertdatetime anchor charmap hr image link code',
                            1 => 'preview media searchreplace print contextmenu paste directionality fullscreen noneditable visualchars nonbreaking',
                        ),
                        'convert_urls' => false,
                        'toolbar1' => 'save | undo redo | cut copy paste pastetext pasteword | search replace | insertdate inserttime | removeformat visualaid | cleanup code | fullscreen | preview | print | spellchecker | help',
                        'toolbar2' => 'bold italic underline strikethrough | justifyleft justifycenter justifyright justifyfull | formatselect fontsizeselect forecolor | blockquote | sub sup | bullist numlist',
                        'toolbar3' => 'tablecontrols | charmap iespell advhr | link unlink anchor image media | cite abbr acronym attribs',
                        'image_advtab' => true,
                    ),
                ),
            ...
            'recipe_settings' => array(
                'loadservices' => true,
                'pagetypes' => array(
                    'recipe_article' => 'Recipe Article',
                    'recipe_cat_page' => 'Recipe Category Page',
                    'recipe_filtered_list' => 'Recipe Filter Results',
                    'recipe_home' => 'Recipe Homepage',
                ),
                'tagcategories' => array(
                    'occasions' => 'Occasions',
                    'everyday' => 'Everyday',
            ...
            'product_settings' => array(
                ...
                'pagetypes' => array(
                    ...
                    'product_cat_page' => 'Product Category Page',
                    'product_filtered_list' => 'Product Filter Results',
                    'product_home' => 'Product Homepage',
                ),
                'tagcategories' => array(
                    'product_featured' => 'Perfect For Product',
                    'sugar_type' => 'Sugar type',
                    'excellent_for' => 'Excellent for',
                    'body' => 'Body',
                ),
                'mediasizes' => array(
                    'original' => 'Original',
