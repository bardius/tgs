...
class __TwigTemplate_e7e3f57d688efedd6fb76a66b8e473721fbe55ce5b4558cdea2f198249364292 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div class=\"large-12 small-12 columns homepageListing\">
    ";
        // line 2
        ...
        ";
            ...
            if ((($this->getAttribute($this->getContext($context, "pageItem"), "pagetype") == "blog_home") || ($this->getAttribute($this->getContext($context, "pageItem"), "pagetype") == "blog_article"))) {
                // line 5
                echo "            ";
                $context["vars"] = array("urlPart" => "blog/");
                // line 6
                echo "        ";
            } elseif (((($this->getAttribute($this->getContext($context, "pageItem"), "pagetype") == "recipe_home") || ($this->getAttribute($this->getContext($context, "pageItem"), "pagetype") == "recipe_cat_page")) || ($this->getAttribute($this->getContext($context, "pageItem"), "pagetype") == "recipe_article"))) {
                // line 7
                echo "            ";
                $context["vars"] = array("urlPart" => "recipe/");
                // line 8
                echo "        ";
            } elseif (((($this->getAttribute($this->getContext($context, "pageItem"), "pagetype") == "product_home") || ($this->getAttribute($this->getContext($context, "pageItem"), "pagetype") == "product_cat_page")) || ($this->getAttribute($this->getContext($context, "pageItem"), "pagetype") == "product_article"))) {
                // line 9
                echo "            ";
                $context["vars"] = array("urlPart" => "product/");
                // line 10
                echo "        ";
            } else {
                // line 11
                echo "            ";
                $context["vars"] = array("urlPart" => "");
                // line 12
                echo "        ";
            }
            echo " 
        ...
        ";
            // line 14
            if ((($this->getAttribute($this->getContext($context, "loop"), "index") % 3) == 1)) {
                echo "    
        <div class=\"columns homepageItem homepageItem";
                // line 15
                ...
                echo " large-3 small-6\">
            ";
                // line 16
                $this->env->loadTemplate("PageBundle:Contents:homepage-item-three.html.twig")->display(array_merge($context, $this->getContext($context, "vars")));
                // line 17
                echo "        </div>
        ";
            } elseif ((($this->getAttribute($this->getContext($context, "loop"), "index") % 3) == 2)) {
                // line 19
                echo "        <div class=\"columns homepageItem homepageItem";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "loop"), "index"), "html", null, true);
                echo " ";
                if ((!(null === $this->getAttribute($this->getContext($context, "pageItem"), "introclass")))) {
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "pageItem"), "introclass"), "html", null, true);
                }
                echo " large-6 small-6\">
            ";
                // line 20
                $this->env->loadTemplate("PageBundle:Contents:homepage-item-six.html.twig")->display(array_merge($context, $this->getContext($context, "vars")));
                // line 21
                echo "        </div>
        ";
            } elseif ((($this->getAttribute($this->getContext($context, "loop"), "index") % 3) == 0)) {
                // line 23
                echo "        <div class=\"columns homepageItem homepageItem";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "loop"), "index"), "html", null, true);
                echo " ";
    ...
    {
        return "PageBundle:Contents:homepage-list.html.twig";
    }
