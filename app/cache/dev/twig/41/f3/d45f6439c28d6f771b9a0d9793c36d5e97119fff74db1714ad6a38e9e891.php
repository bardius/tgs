...
class __TwigTemplate_41f3d45f6439c28d6f771b9a0d9793c36d5e97119fff74db1714ad6a38e9e891 extends Twig_Template
{
    ...
    {
        // line 3
        $context["__internal_2ddc5df36a6fa4627c8c7b7006a295e69b4e7f12880fc08fdd495e67a8cca658"] = $this;
        // line 5
...
";
    ...
    ";
        // line 80
        echo $this->callMacro($context["__internal_2ddc5df36a6fa4627c8c7b7006a295e69b4e7f12880fc08fdd495e67a8cca658"], "display_timeline", array(0 => ("timeline_" . $this->getContext($context, "token")), 1 => $this->getAttribute($this->getContext($context, "collector"), "events"), 2 => $this->getContext($context, "colors")));
        echo "
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "children"))) {
            ...
            ";
                // line 90
                echo $this->callMacro($context["__internal_2ddc5df36a6fa4627c8c7b7006a295e69b4e7f12880fc08fdd495e67a8cca658"], "display_timeline", array(0 => ("timeline_" . $this->getAttribute($this->getContext($context, "child"), "token")), 1 => $this->getContext($context, "events"), 2 => $this->getContext($context, "colors")));
                echo "
        ";
            }
...
";
        // line 391
        echo $this->callMacro($context["__internal_2ddc5df36a6fa4627c8c7b7006a295e69b4e7f12880fc08fdd495e67a8cca658"], "dump_request_data", array(0 => $this->getContext($context, "token"), 1 => $this->getContext($context, "profile"), 2 => $this->getAttribute($this->getContext($context, "collector"), "events"), 3 => $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin")));
        echo "
...
";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                // line 396
                echo $this->callMacro($context["__internal_2ddc5df36a6fa4627c8c7b7006a295e69b4e7f12880fc08fdd495e67a8cca658"], "dump_request_data", array(0 => $this->getAttribute($this->getContext($context, "child"), "token"), 1 => $this->getContext($context, "child"), 2 => $this->getAttribute($this->getAttribute($this->getContext($context, "child"), "getcollector", array(0 => "time"), "method"), "events"), 3 => $this->getAttribute($this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "events"), "__section__"), "origin")));
...
";
    ...
    public function getDump_request_data($_token = null, $_profile = null, $_events = null, $_origin = null)
    {
        ...
        try {
            // line 435
            $context["__internal_71ce8f60b5d75e70cb5eb1cf9ec6d3b57f38b530dab52283d139219c5112f713"] = $this;
            // line 436
            echo "                {
                    \"id\": \"";
            // line 437
...
";
            // line 440
            echo $this->callMacro($context["__internal_71ce8f60b5d75e70cb5eb1cf9ec6d3b57f38b530dab52283d139219c5112f713"], "dump_events", array(0 => $this->getContext($context, "events")));
            echo "
                    ]
                }
";
