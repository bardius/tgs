...
class __TwigTemplate_f782c01102546b72b8510210a6512aaffdef95c814556b75f1e5aac2294f04f4 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div class=\"column twelve\">
    <h3>Our Range</h3>
</div>
";
        // line 4
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "rangelist"));
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
            if ($this->getAttribute($this->getAttribute($this->getContext($context, "product", true), "productimage", array(), "any", false, true), "id", array(), "any", true, true)) {
                // line 5
                echo "        <div class=\"rangeProduct ";
                if ((!(null === $this->getAttribute($this->getContext($context, "product"), "pageclass")))) {
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "product"), "pageclass"), "html", null, true);
                }
                echo " column one mobile-one\">
            <a href=\"";
                // line 6
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("ProductBundle_page_normal", array("alias" => $this->getAttribute($this->getContext($context, "product"), "alias"))), "html", null, true);
                echo "\" title=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "product"), "title"), "html", null, true);
                echo "\">
                ";
                // line 7
                echo $this->env->getExtension('sonata_media')->media($this->getAttribute($this->getAttribute($this->getContext($context, "product"), "productimage"), "id"), "xsmall", array("alt" => $this->getAttribute($this->getContext($context, "product"), "title"), "title" => ""));
                // line 8
                echo "                <span>";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "product"), "title"), "html", null, true);
                echo "</span>
...
";
    ...
    {
        return "ProductBundle:Contents:range-list.html.twig";
    }
