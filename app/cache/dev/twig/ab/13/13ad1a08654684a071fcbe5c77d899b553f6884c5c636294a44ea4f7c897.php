...
/* PageBundle:Admin:edit.html.twig */
class __TwigTemplate_ab1313ad1a08654684a071fcbe5c77d899b553f6884c5c636294a44ea4f7c897 extends Twig_Template
{
    ...
    <img src=\"";
        // line 2
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/sonataadmin/famfamfam/pencil.png"), "html", null, true);
        echo "\" alt=\"";
        echo $this->env->getExtension('translator')->getTranslator()->trans("action_edit", array(), "SonataAdminBundle");
        echo "\" />
</a>";
    ...
    {
        return "PageBundle:Admin:edit.html.twig";
    }
