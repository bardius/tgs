...
/* ProductBundle:Contents:product-packages.html.twig */
class __TwigTemplate_3fc48bdc10454994423f70445f8463ea16c11a46c6652125c5bbe4d76552c443 extends Twig_Template
{
    ...
    <h4>Buy online from our selected retailers</h4>
</div>
";
        // line 4
        if ($this->getAttribute($this->getContext($context, "page"), "packageSize1")) {
            // line 5
            echo "    <div class=\"column productPackage four mobile-four\">
        <a class=\"productBuyLink\" href=\"http://tateandlyle.where-to-buy.co/Widgets/CrossDevicePartial/";
            // line 6
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "page"), "manufacturersPartNo1"), "html", null, true);
            echo "\" title=\"Buy Now\">
            <span class=\"sizeText\">";
            // line 7
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "page"), "packageSize1"), "html", null, true);
            echo "</span><span>Buy Now</span>
        </a>
    </div>
";
        }
        // line 11
        if ($this->getAttribute($this->getContext($context, "page"), "packageSize2")) {
            // line 12
            echo "    <div class=\"column productPackage four mobile-four\">
        <a class=\"productBuyLink\" href=\"http://tateandlyle.where-to-buy.co/Widgets/CrossDevicePartial/";
            // line 13
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "page"), "manufacturersPartNo2"), "html", null, true);
            echo "\" title=\"Buy Now\">
            <span class=\"sizeText\">";
            // line 14
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "page"), "packageSize2"), "html", null, true);
            echo "</span><span>Buy Now</span>
        </a>
    </div>
";
        ...
        // line 18
        if ($this->getAttribute($this->getContext($context, "page"), "packageSize3")) {
            // line 19
            echo "    <div class=\"column productPackage four mobile-four\">
        <a class=\"productBuyLink\" href=\"http://tateandlyle.where-to-buy.co/Widgets/CrossDevicePartial/";
            // line 20
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "page"), "manufacturersPartNo3"), "html", null, true);
            echo "\" title=\"Buy Now\">
            <span class=\"sizeText\">";
            // line 21
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "page"), "packageSize3"), "html", null, true);
            echo "</span><span>Buy Now</span>
        </a>
    </div>
";
            ...
            // line 25
            echo "   <span class=\"packagesListCopy\"><span class=\"packagesListCopy1\">Start <br /></span><span class=\"packagesListCopy2\">cooking</span></span>
";
        }
        // line 27
        echo "<div class=\"twelve column mobile-nine \">
    <p>Tate &amp; Lyle Sugars cannot guarantee stock availability</p>
</div>";
    }

    public function getTemplateName()
    {
        return "ProductBundle:Contents:product-packages.html.twig";
    }
