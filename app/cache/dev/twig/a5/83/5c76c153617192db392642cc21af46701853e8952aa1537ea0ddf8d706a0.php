...
/* ProductBundle:Contents:page-list-item.html.twig */
class __TwigTemplate_a5835c76c153617192db392642cc21af46701853e8952aa1537ea0ddf8d706a0 extends Twig_Template
{
    ...
    <a href=\"";
        // line 2
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("ProductBundle_page_normal", array("alias" => $this->getAttribute($this->getContext($context, "pageItem"), "alias"))), "html", null, true);
        echo "\" title=\"";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "pageItem"), "title"), "html", null, true);
        echo "\">
        ";
        // line 3
        if ($this->getAttribute($this->getAttribute($this->getContext($context, "pageItem", true), "productlistimage", array(), "any", false, true), "id", array(), "any", true, true)) {
            // line 4
            echo "        ";
            echo $this->env->getExtension('sonata_media')->media($this->getAttribute($this->getAttribute($this->getContext($context, "pageItem"), "productlistimage"), "id"), "medium", array("alt" => $this->getAttribute($this->getContext($context, "pageItem"), "title"), "title" => ""));
            // line 5
            echo "        ";
        }
        // line 6
        echo "        <div class=\"productItemText ";
        if ($this->getAttribute($this->getContext($context, "pageItem", true), "pageclass", array(), "any", true, true)) {
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "pageItem"), "pageclass"), "html", null, true);
        }
        echo "\">
            <h5 class=\"title\"><span>";
        // line 7
        ...
        echo "</span></h5>
            ";
        // line 8
        $this->env->loadTemplate("ProductBundle:Contents:listitem-featured-tags.html.twig")->display($context);
        // line 9
        echo "        </div>
    </a>
</div>";
    ...
    {
        return "ProductBundle:Contents:page-list-item.html.twig";
    }
