...
/* RecipeBundle:Contents:page-list-item.html.twig */
class __TwigTemplate_a5a0c1cee0f7f62912d69da314c3d6a3042151f6c2241aecb6f7a4a4ee09763f extends Twig_Template
{
    ...
    <a href=\"";
        // line 2
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("RecipeBundle_page_normal", array("alias" => $this->getAttribute($this->getContext($context, "pageItem"), "alias"))), "html", null, true);
        echo "\" title=\"";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "pageItem"), "title"), "html", null, true);
        echo "\">
        ";
        // line 3
        if ($this->getAttribute($this->getAttribute($this->getContext($context, "pageItem", true), "recipeimage", array(), "any", false, true), "id", array(), "any", true, true)) {
            // line 4
            echo "        ";
            echo $this->env->getExtension('sonata_media')->media($this->getAttribute($this->getAttribute($this->getContext($context, "pageItem"), "recipeimage"), "id"), "small", array("alt" => $this->getAttribute($this->getContext($context, "pageItem"), "title"), "title" => ""));
            // line 5
            echo "        ";
        } else {
            // line 6
        ...
        if ($this->getAttribute($this->getAttribute($this->getContext($context, "pageItem", true), "product", array(), "any", false, true), "pageclass", array(), "any", true, true)) {
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "pageItem"), "product"), "pageclass"), "html", null, true);
        }
        echo "\">
            <h5 class=\"title\"><span>";
        // line 9
        ...
        // line 10
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "pageItem"), "preperation"), "html", null, true);
        echo "</span>
            <span class=\"itemIcon cooking\">";
        // line 11
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "pageItem"), "cooking"), "html", null, true);
        echo "</span>
            <span class=\"itemIcon servings\">";
        // line 12
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "pageItem"), "servings"), "html", null, true);
        echo "</span>
        </div>
    </a>
</div>";
    ...
    {
        return "RecipeBundle:Contents:page-list-item.html.twig";
    }
