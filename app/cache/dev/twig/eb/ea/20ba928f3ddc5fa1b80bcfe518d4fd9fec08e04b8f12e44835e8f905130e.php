...
class __TwigTemplate_ebea20ba928f3ddc5fa1b80bcfe518d4fd9fec08e04b8f12e44835e8f905130e extends Twig_Template
{
    ...
    {
        // line 1
        echo "<ul id=\".photoswipegallery1\" class=\"photoswipegallery\">
    <li><a href=\"";
        // line 2
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "uriForPath", array(0 => "/images/site_assets/top_slides/slide1.jpg"), "method"), "html", null, true);
        echo "\"><img alt=\"slide1\" src=\"";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "uriForPath", array(0 => "/images/site_assets/top_slides/slide1.jpg"), "method"), "html", null, true);
        echo "\" /></a></li>
    <li><a href=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "uriForPath", array(0 => "/images/site_assets/top_slides/slide2.jpg"), "method"), "html", null, true);
        echo "\"><img alt=\"slide2\" src=\"";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "uriForPath", array(0 => "/images/site_assets/top_slides/slide2.jpg"), "method"), "html", null, true);
        echo "\" /></a></li>
    <li><a href=\"";
        // line 4
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "uriForPath", array(0 => "/images/site_assets/top_slides/slide3.jpg"), "method"), "html", null, true);
        echo "\"><img alt=\"slide3\" src=\"";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "uriForPath", array(0 => "/images/site_assets/top_slides/slide3.jpg"), "method"), "html", null, true);
        echo "\" /></a></li>
</ul>
";
    ...
    {
        return ":examples:swipe_gallery_example.html.twig";
    }
