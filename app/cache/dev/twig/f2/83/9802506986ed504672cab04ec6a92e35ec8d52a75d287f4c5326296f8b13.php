...
/* BlogBundle:Contents:page-list-item.html.twig */
class __TwigTemplate_f2839802506986ed504672cab04ec6a92e35ec8d52a75d287f4c5326296f8b13 extends Twig_Template
{
    ...
    <span class=\"date\"><span class=\"day\">";
        // line 2
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->getContext($context, "pageItem"), "date"), "d"), "html", null, true);
        echo "</span><span class=\"month\">";
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->getContext($context, "pageItem"), "date"), "M"), "html", null, true);
        echo "</span></span>
    ";
        // line 3
        if ($this->getAttribute($this->getAttribute($this->getContext($context, "pageItem", true), "introimage", array(), "any", false, true), "id", array(), "any", true, true)) {
            // line 4
            echo "    <div class=\"column five mobile-four\">
    <a href=\"";
            // line 5
        ...
        ";
            // line 6
            echo $this->env->getExtension('sonata_media')->media($this->getAttribute($this->getAttribute($this->getContext($context, "pageItem"), "introimage"), "id"), "blog", array("alt" => $this->getAttribute($this->getContext($context, "pageItem"), "title"), "title" => ""));
            // line 7
            echo "    </a>
    </div>
    <div class=\"column seven mobile-five introItemText\">
    ";
        } else {
            // line 11
            echo "    <div class=\"column twelve mobile-nine introItemText\">
    ";
        }
        // line 13
        echo "        <h4>
    ...
    {
        return "BlogBundle:Contents:page-list-item.html.twig";
    }
