...
/* ProductBundle:Contents:listitem-featured-tags.html.twig */
class __TwigTemplate_3c4c14ebb83fc0f4c2a17e892f04f680973229847cf0fa0063fe73a6aa60a653 extends Twig_Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["tag"]) {
            if (($this->getAttribute($this->getContext($context, "tag"), "tagCategory") == "product_featured")) {
                ...
                if (($this->getAttribute($this->getContext($context, "loop"), "index0") == 0)) {
                    // line 3
                    echo " <p class=\"featuredTagsHeading\">Wonderful in</p>
 <span class=\"featuredTags\">
 ";
                }
                // line 6
                echo "    ";
                if (($this->getAttribute($this->getContext($context, "loop"), "index0") < 3)) {
                    // line 7
                    echo "    <span class=\"tagIcon tagIcon";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "loop"), "index0"), "html", null, true);
                    echo "\">
    ";
                    // line 8
                    if ((!twig_test_empty($this->getAttribute($this->getAttribute($this->getContext($context, "tag"), "smallIcon"), "id")))) {
                        // line 9
                        echo "        ";
                        echo $this->env->getExtension('sonata_media')->media($this->getAttribute($this->getAttribute($this->getContext($context, "tag"), "smallIcon"), "id"), "small", array("alt" => $this->getAttribute($this->getContext($context, "tag"), "title"), "title" => $this->getAttribute($this->getContext($context, "tag"), "title")));
                        // line 10
                        echo "    ";
                    }
                    echo " 
    ...
    {
        return "ProductBundle:Contents:listitem-featured-tags.html.twig";
    }
