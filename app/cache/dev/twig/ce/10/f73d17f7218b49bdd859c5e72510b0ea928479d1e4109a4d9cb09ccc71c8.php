...
/* PageBundle:Contents:page-list-product-item.html.twig */
class __TwigTemplate_ce10f73d17f7218b49bdd859c5e72510b0ea928479d1e4109a4d9cb09ccc71c8 extends Twig_Template
{
    ...
    ";
        ...
        ";
                ...
                // line 6
                echo "            <a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("ProductBundle_showPage", array("id" => $this->getAttribute($this->getContext($context, "pageItem"), "id"))), "html", null, true);
                echo "\" title=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "pageItem"), "title"), "html", null, true);
                echo "\" class=\"readMoreImage\">
        ";
    ...
    {
        return "PageBundle:Contents:page-list-product-item.html.twig";
    }
