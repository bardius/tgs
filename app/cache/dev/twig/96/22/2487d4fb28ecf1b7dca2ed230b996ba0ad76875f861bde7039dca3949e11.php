...
/* PageBundle:Contents:page-list-recipe-item.html.twig */
class __TwigTemplate_96222487d4fb28ecf1b7dca2ed230b996ba0ad76875f861bde7039dca3949e11 extends Twig_Template
{
    ...
    ";
        ...
        ";
                ...
                // line 6
                echo "            <a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getUrl("RecipeBundle_showPage", array("id" => $this->getAttribute($this->getContext($context, "pageItem"), "id"))), "html", null, true);
                echo "\" title=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "pageItem"), "title"), "html", null, true);
                echo "\" class=\"readMoreImage\">
        ";
    ...
    {
        return "PageBundle:Contents:page-list-recipe-item.html.twig";
    }
