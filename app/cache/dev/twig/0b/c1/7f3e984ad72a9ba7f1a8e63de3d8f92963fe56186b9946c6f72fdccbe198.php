...
/* PageBundle:Contents:modalcontentblocks.html.twig */
class __TwigTemplate_0bc17f3e984ad72a9ba7f1a8e63de3d8f92963fe56186b9946c6f72fdccbe198 extends Twig_Template
{
        ...
        if ((!(null === $this->getAttribute($this->getContext($context, "page"), "modalcontentblocks")))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["contentBlock"]) {
                ...
                if (($this->getAttribute($this->getContext($context, "contentBlock"), "publishedState") == 1)) {
                    // line 4
                    echo "        <div class=\"reveal-modal contentBlock ";
...
";
    ...
    {
        return "PageBundle:Contents:modalcontentblocks.html.twig";
    }
