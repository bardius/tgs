...
class __TwigTemplate_7f05544b6535f40043ba6f2d0d840378d5f7d2a2de66dd3aa870764d0eea1b14 extends Twig_Template
{
    ...
    {
        // line 1
        if ((!(null === $this->getAttribute($this->getContext($context, "page"), "tags")))) {
            // line 2
            echo "<div class=\"twelve column featuredTags hide-for-small\">
    ";
            // line 3
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, "page"), "tags"));
            $context['loop'] = array(
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["tag"]) {
                if (($this->getAttribute($this->getContext($context, "tag"), "tagCategory") == "product_featured")) {
                    // line 4
                    echo "    ";
                    if (($this->getAttribute($this->getContext($context, "loop"), "index0") == 0)) {
                        // line 5
                        echo "    <h4>Perfect for</h4>
    <ul>
    ";
                    }
                    // line 8
                    echo "    ";
                    if (($this->getAttribute($this->getContext($context, "loop"), "index0") < 3)) {
                        // line 9
                        echo "        <li class=\"tagIcon tagIcon";
                        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "loop"), "index0"), "html", null, true);
                        echo "\">
        ";
                        // line 10
                        if ((!twig_test_empty($this->getAttribute($this->getAttribute($this->getContext($context, "tag"), "tagIcon"), "id")))) {
                            // line 11
                            echo "            <span class='tagImage'>";
                            echo $this->env->getExtension('sonata_media')->media($this->getAttribute($this->getAttribute($this->getContext($context, "tag"), "tagIcon"), "id"), "medium", array("alt" => $this->getAttribute($this->getContext($context, "tag"), "title"), "title" => ""));
                            echo "</span>
        ";
                        }
                        // line 13
                        echo "        <span class='tagTitle'>";
                        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "tag"), "title"), "html", null, true);
                        echo "</span>
        </li>
    ";
                    }
...
";
    ...
    {
        return "ProductBundle:Contents:featured-tags.html.twig";
    }
