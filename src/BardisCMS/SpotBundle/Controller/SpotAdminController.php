...
class SpotAdminController extends Controller
{
    ...
    public function duplicateAction($id = null)
    {
        ...
        if (!$object) {
            throw new NotFoundHttpException(sprintf('unable to find the Spot Page with id : %s', $id));
        }
        ...
        foreach ($form->getData()->getSecondarycontentblocks() as $secondarycontentblocks) {
            unset($secondarycontentblocks);
        }
