...
class DefaultController extends Controller
{
    ...
    public function renderPage($page, $id, $publishStates, $extraParams, $currentpage, $totalpageitems, $linkUrlParams){
        ...
        {          
            ...
            $response = $this->render('SpotBundle:Default:page.html.twig', array('page' => $page, 'pages' => $pages, 'totalPages' => $totalPages, 'extraParams' => $extraParams, 'currentpage' => $currentpage, 'linkUrlParams' => $linkUrlParams, 'totalpageitems' => $totalpageitems, 'filterForm' => $filterForm->createView()));
        }
        ...
        {   
            ...
            $response = $this->render('SpotBundle:Default:page.html.twig', array('page' => $page, 'relatedDestinations' => $associatedDestinations,  'relatedSpots' => $relatedSpots, 'weatherData' => $weatherData));
        }
		else{        
