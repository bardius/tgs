            ...
            switch ($this->subject->getPagetype()) {
                ...
                $formMapper                          
						...
						->with('Spot Page Contents', array('collapsed' => true))
                            ...
                            ->add('extracontentblocks','contentblockcollection', array('attr' => array('class' => 'modalcontentblocks'), 'label' => 'Photogallery Contents')) 
                            ->setHelps(array(
                                ...
                                'extracontentblocks'        => 'Enter the contents for Photogallery'
                            )) 
                        ->end()
                    ;
                    break;
