 ...
 *
 */
namespace BardisCMS\RecipeBundle\Repository;
...
class RecipeRepository extends EntityRepository
{
    ...
    public function getTaggedCategoryItems($categoryIds, $currentPageId, $publishStates, $currentpage, $totalpageitems, $tagIds)
    {
        ...
        if(!empty($categoryIds))
        {
            ...
            $qb->select('DISTINCT p')
                ...
                ->setParameter('publishState', $publishStates)
                ->setParameter('pagetype', 'recipe_article')
                ->setParameter('currentPage', $currentPageId)
            ;
    ...
    public function getRelatedRecipes($productId, $currentPageId, $publishStates)
    {   
        $relatedRecipes = null;
        ...
        if(!empty($productId))
        {
            ...
            $relatedRecipes = $qb->getQuery()->getResult();
        }
        
        return  $relatedRecipes;
    }
    
    public function getRelatedProductRecipes($productId, $publishStates)
    {   
