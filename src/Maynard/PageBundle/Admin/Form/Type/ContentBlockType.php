 ...
 *
 */
namespace Maynard\PageBundle\Admin\Form\Type;
...
use Maynard\PageBundle\Admin\Form\EventListener\AddIdFieldSubscriber;
use Maynard\PageBundle\Entity\ContentBlock;
use Maynard\PageBundle\Admin\Form\EventListener\AddContentTypeFieldSubscriber;
...
class ContentBlockType extends AbstractType
{
    ...
    {   
        $optionsNormalizer = function (Options $options, $value) {
            $value = 'Maynard\PageBundle\Entity\ContentBlock';
