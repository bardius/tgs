...
namespace Maynard\ProductBundle\Admin;
    ...
    {        
		...
		->add('author',  'entity', array('class' => 'Application\Sonata\UserBundle\Entity\User', 'property' => 'username', 'expanded' => false, 'multiple' => false, 'label' => 'Author', 'data' => $loggedUser->getUsername(), 'required' => true))
            ...
            ->with('Categories & Tags', array('collapsed' => true))
                ->add('categories', 'entity', array('class' => 'Maynard\ProductBundle\Entity\ProductCategory', 'property' => 'title', 'expanded' => true, 'multiple' => true, 'label' => 'Associated Categories', 'required' => false))
                ->add('tags', 'entity', array('class' => 'Maynard\ProductBundle\Entity\ProductTag', 'property' => 'title', 'expanded' => true, 'multiple' => true, 'label' => 'Associated Tags', 'required' => false))                
                ->setHelps(array(
            ...
            switch ($this->subject->getPagetype()) {
                ...
                $formMapper
                        ->with('Page Specific Information', array('collapsed' => true))
                            ...
                            ->add('topArrowText', null, array('label' => 'Top Arrow Text', 'required' => false))
                            ->add('featuredProduct', 'entity', array('class' => 'Maynard\ProductBundle\Entity\Product', 'property' => 'title', 'expanded' => false, 'multiple' => false, 'label' => 'Select Featured Product', 'attr' => array('class' => 'autoCompleteItems autoCompleteProduct'), 'required' => false))
                            ->add('pageclass', null, array('label' => 'Product Page CSS Class', 'required' => false))
                        ->setHelps(array(
                                'showPageTitle'     => 'Hide / Show The title of the page',
