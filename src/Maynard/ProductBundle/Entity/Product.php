...
use Maynard\ProductBundle\Entity\ProductCategory;
use Maynard\ProductBundle\Entity\ProductTag;


/**
 * Maynard\ProductBundle\Entity\Product
 *
 * @ORM\Table(name="products")
 * @DoctrineAssert\UniqueEntity(fields="alias", message="Alias must be unique")
 * @ORM\Entity(repositoryClass="Maynard\ProductBundle\Repository\ProductRepository")
 */
class Product
{
    /**
    ...
    /**
    * @ORM\ManyToMany(targetEntity="Maynard\ProductBundle\Entity\ProductCategory", inversedBy="products", cascade={"persist"})
    * @ORM\JoinTable(name="products_categories")
    */
    protected $categories;

    /**
    * @ORM\ManyToMany(targetEntity="Maynard\ProductBundle\Entity\ProductTag", inversedBy="products", cascade={"persist"})
    ...
    */
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Maynard\PageBundle\Entity\ContentBlock", inversedBy="product_maincontents", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Maynard\PageBundle\Entity\ContentBlock", inversedBy="product_secondarycontents", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Maynard\PageBundle\Entity\ContentBlock", inversedBy="product_modalcontents", cascade={"persist"})
     * @ORM\JoinTable(name="product_modalcontent_blocks")
     **/
    protected $modalcontentblocks;
    
    /**
     * @ORM\ManyToOne(targetEntity="Maynard\ProductBundle\Entity\Product", cascade={"persist"})
     ...
     * Set featuredProduct
     *
     * @param \Maynard\ProductBundle\Entity\Product $featuredProduct
     * @return Products
     */
    public function setFeaturedProduct(\Maynard\ProductBundle\Entity\Product $featuredProduct = null)
    {
     ...
     * Add categories
     *
     * @param \Maynard\ProductBundle\Entity\ProductCategory $categories
     * @return Products
     */
    public function addCategory(\Maynard\ProductBundle\Entity\ProductCategory $categories)
    {
     ...
     * @param \Maynard\ProductBundle\Entity\ProductCategory $categories
     */
    public function removeCategory(\Maynard\ProductBundle\Entity\ProductCategory $categories)
    {
     ...
     * Add tags
     *
     * @param \Maynard\ProductBundle\Entity\ProductTag $tags
     * @return Products
     */
    public function addTag(\Maynard\ProductBundle\Entity\ProductTag $tags)
    {
        $this->tags[] = $tags;
     ...
     * @param \Maynard\ProductBundle\Entity\ProductTag $tags
     */
    public function removeTag(\Maynard\ProductBundle\Entity\ProductTag $tags)
    {
