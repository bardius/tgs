...
namespace Maynard\SkeletonBundle\Entity;
...
/**
 * Maynard\SkeletonBundle\Entity\Skeleton
 *
 * @ORM\Table(name="skeletons")
 * @DoctrineAssert\UniqueEntity(fields="alias", message="Alias must be unique")
 * @ORM\Entity(repositoryClass="Maynard\SkeletonBundle\Repository\SkeletonRepository")
 */
class Skeleton
{
    /**
    ...
    /**
    * @ORM\ManyToMany(targetEntity="Maynard\PageBundle\Entity\Category", inversedBy="skeletons", cascade={"persist"})
    * @ORM\JoinTable(name="skeletons_categories")
    */
    protected $categories;

    /**
    * @ORM\ManyToMany(targetEntity="Maynard\PageBundle\Entity\Tag", inversedBy="skeletons", cascade={"persist"})
    ...
    */
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Maynard\PageBundle\Entity\ContentBlock", inversedBy="skeleton_maincontents", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Maynard\PageBundle\Entity\ContentBlock", inversedBy="skeleton_bannercontents", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Maynard\PageBundle\Entity\ContentBlock", inversedBy="skeleton_modalcontents", cascade={"persist"})
