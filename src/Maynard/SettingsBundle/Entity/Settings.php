 ...
 *
 */
namespace Maynard\SettingsBundle\Entity;

use Doctrine\ORM\Mapping as ORM;


/**
 * Maynard\SettingsBundle\Entity\Settings
 *
 * @ORM\Table(name="settings")
 * @ORM\Entity(repositoryClass="Maynard\SettingsBundle\Repository\SettingsRepository")
 */
class Settings
{
    /**
