    ...
    {        
		...
		->add('author',  'entity', array('class' => 'Application\Sonata\UserBundle\Entity\User', 'property' => 'username', 'expanded' => false, 'multiple' => false, 'label' => 'Author', 'data' => $loggedUser->getUsername(), 'required' => true))
                ...
                ->setHelps(array(
                    ...
                    'pagetype'      => 'Select the type of the Page (Recipe Page template)'
                ))
            ->end()
            ->with('Categories & Tags', array('collapsed' => true))
                ->add('categories', 'entity', array('class' => 'Maynard\RecipeBundle\Entity\RecipeCategory', 'property' => 'title', 'expanded' => true, 'multiple' => true, 'label' => 'Associated Categories', 'required' => false))
                ->add('tags', 'entity', array('class' => 'Maynard\RecipeBundle\Entity\RecipeTag', 'property' => 'title', 'expanded' => true, 'multiple' => true, 'label' => 'Associated Tags', 'required' => false))                
                ->setHelps(array(
            ...
            ->with('Homepage & Listing Page Intro', array('collapsed' => true))
                ...
                ->setHelps(array(
                    ...
                    'pageOrder'     => 'Set the order of this Recipe page intro for the homepage',
        ...
        if(!is_null($this->getSubject()->getId()))
        {
            ...
            switch ($this->subject->getPagetype()) {
                case 'recipe_article':
                $formMapper                        
                        ->with('Recipe Specific Information', array('collapsed' => true))
                            ...
                            ->add('summary', 'textarea', array('attr' => array('class' => 'tinymce', 'data-theme' => 'advanced'), 'label' => 'Recipe Description', 'required' => false))
                            ->add('recipeimage', 'sonata_media_type', array( 'provider' => 'sonata.media.provider.image', 'context' => 'recipe', 'attr' => array( 'class' => 'imagefield'), 'label' => 'Recipe Image', 'required' => false))
                            ...
                            ->add('pageclass', null, array('label' => 'Recipe Page CSS Class', 'required' => false))
                            ->add('product', 'entity', array('class' => 'Maynard\ProductBundle\Entity\Product', 'property' => 'title', 'expanded' => false, 'multiple' => false, 'label' => 'Select Related Product', 'attr' => array('class' => 'autoCompleteItems autoCompleteProduct'), 'required' => false))
                        ->setHelps(array(
                                'showPageTitle' => 'Hide / Show The title of the page',
                                'summary'       => 'Set the Recipe Description',
                                'recipeimage'   => 'Set the Recipe Image',
                                'bgimage'       => 'Set the Recipe Top Background Image',
                                'preperation'   => 'Set the Preperation Time',
                                'cooking'       => 'Set the Cooking Time',
                                'servings'      => 'Set the Total Servings',
                                'pageclass'     => 'Set the Color CSS class for this Recipe',
                                'product'       => 'Select the related Product for this Recipe'
                        ))
                        ->end()
                        ->with('Recipe Page Contents', array('collapsed' => true))
                            ->add('maincontentblocks','contentblockcollection', array('attr' => array('class' => 'maincontentblocks'), 'label' => 'Recipe Instructions')) 
                            ->add('secondarycontentblocks','contentblockcollection', array('attr' => array('class' => 'maincontentblocks'), 'label' => 'Recipe Ingredients')) 
                            //->add('extracontentblocks','contentblockcollection', array('attr' => array('class' => 'maincontentblocks'), 'label' => 'Recipe extras')) 
                            ->add('modalcontentblocks','contentblockcollection', array('attr' => array('class' => 'modalcontentblocks'), 'label' => 'Recipe Nutritional Information'))
                            //->add('bannercontentblocks','contentblockcollection', array('attr' => array('class' => 'bannercontentblocks'), 'label' => 'Bottom Contents'))
                            ->setHelps(array(
                                //'bannercontentblocks'       => 'Select the top contents in the order you want them to appear in the Recipe Page',
                                //'extracontentblocks'        => 'Select the top contents in the order you want them to appear in the Recipe Page',
                                'maincontentblocks'         => 'Enter the contents for the Recipe Instructions',
                                'secondarycontentblocks'    => 'Enter the contents for the Recipe Ingredients',
                ...
                $formMapper
                        ->with('Page Specific Information', array('collapsed' => true))
                            ...
                            ->add('recipeimage', 'sonata_media_type', array( 'provider' => 'sonata.media.provider.image', 'context' => 'recipe', 'attr' => array( 'class' => 'imagefield'), 'label' => 'Intro Image', 'required' => false))
                            ...
                            ->add('preperation', null, array('label' => 'Featured Recipe Url', 'required' => false))
                            ->add('cooking', null, array('label' => 'Featured Recipe Playfull Copy', 'required' => false))
                            ->add('pageclass', null, array('label' => 'Recipe Page CSS Class', 'required' => false))
                        ->setHelps(array(
                                'showPageTitle' => 'Hide / Show The title of the page',
                                'summary'       => 'Set the Category Description',
                                'recipeimage'   => 'Set the Image content to display for intro listing items',
                                'bgimage'       => 'Set the Top Background Image',
                                'preperation'   => 'Set the Featured Recipe Url',
                                'cooking'       => 'Set the Featured Recipe Playfull Copy',
                                'pageclass'     => 'Set the CSS class for this page'
                        ))
                        ->end()
                        ->with('Recipe List Page Contents', array('collapsed' => true))
                            ->add('maincontentblocks','contentblockcollection', array('attr' => array('class' => 'maincontentblocks'), 'label' => 'Contents above the Recipe List'))
                            ->add('secondarycontentblocks','contentblockcollection', array('attr' => array('class' => 'maincontentblocks'), 'label' => 'Contents below the Recipe List'))  
                            ->add('modalcontentblocks','contentblockcollection', array('attr' => array('class' => 'modalcontentblocks'), 'label' => 'Modal Windows Contents')) 
                            ->setHelps(array(
                                'maincontentblocks'         => 'Select the contents in the order you want them to appear above the recipe list',
                                'secondarycontentblocks'    => 'Select the contents in the order you want them to appear below the recipe list',
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            ->add('_action', 'actions', array( 
                    'actions' => array(  
                        'duplicate' => array(
                            'template' => 'RecipeBundle:Admin:duplicate.html.twig'
                        ),
                        'edit' => array(
