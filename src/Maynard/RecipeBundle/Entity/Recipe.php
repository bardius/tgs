...
namespace Maynard\RecipeBundle\Entity;
...
use Maynard\RecipeBundle\Entity\RecipeCategory;
use Maynard\RecipeBundle\Entity\RecipeTag;


/**
 * Maynard\RecipeBundle\Entity\Recipe
 *
 * @ORM\Table(name="recipes")
 * @DoctrineAssert\UniqueEntity(fields="alias", message="Alias must be unique")
 * @ORM\Entity(repositoryClass="Maynard\RecipeBundle\Repository\RecipeRepository")
 */
class Recipe
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Maynard\ProductBundle\Entity\Product")
     * @ORM\JoinColumn(name="product", referencedColumnName="id", onDelete="SET NULL")
     */
    protected $product;

    /**
    * @ORM\ManyToMany(targetEntity="Maynard\RecipeBundle\Entity\RecipeCategory", inversedBy="recipes", cascade={"persist"})
    * @ORM\JoinTable(name="recipes_categories")
    */
    protected $categories;

    /**
    * @ORM\ManyToMany(targetEntity="Maynard\RecipeBundle\Entity\RecipeTag", inversedBy="recipes", cascade={"persist"})
    ...
    */
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Maynard\PageBundle\Entity\ContentBlock", inversedBy="recipe_maincontents", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Maynard\PageBundle\Entity\ContentBlock", inversedBy="recipe_secondarycontents", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Maynard\PageBundle\Entity\ContentBlock", inversedBy="recipe_extracontents", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Maynard\PageBundle\Entity\ContentBlock", inversedBy="recipe_bannercontents", cascade={"persist"})
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Maynard\PageBundle\Entity\ContentBlock", inversedBy="recipe_modalcontents", cascade={"persist"})
     ...
     * Add categories
     *
     * @param \Maynard\RecipeBundle\Entity\RecipeCategory $categories
     * @return Recipe
     */
    public function addCategory(\Maynard\RecipeBundle\Entity\RecipeCategory $categories)
    {
     ...
     * @param \Maynard\RecipeBundle\Entity\RecipeCategory $categories
     */
    public function removeCategory(\Maynard\RecipeBundle\Entity\RecipeCategory $categories)
    {
     ...
     * Add tags
     *
     * @param \Maynard\RecipeBundle\Entity\RecipeTag $tags
     * @return Recipe
     */
    public function addTag(\Maynard\RecipeBundle\Entity\RecipeTag $tags)
    {
        $this->tags[] = $tags;
     ...
     * @param \Maynard\RecipeBundle\Entity\RecipeTag $tags
     */
    public function removeTag(\Maynard\RecipeBundle\Entity\RecipeTag $tags)
    {
     ...
     * Set product
     *
     * @param \Maynard\ProductBundle\Entity\Product $product
     * @return Recipe
     */
    public function setProduct(\Maynard\ProductBundle\Entity\Product $product = null)
    {
     ...
     * Get product
     *
     * @return \Maynard\ProductBundle\Entity\Product 
     */
     ...
     *
     * @param \Maynard\PageBundle\Entity\ContentBlock $secondarycontentblocks
     * @return Recipe
     */
     ...
     *
     * @param \Maynard\PageBundle\Entity\ContentBlock $extracontentblocks
     * @return Recipe
     */
