<?php /* Smarty version 2.6.19, created on 2013-08-05 19:44:35
         compiled from index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'index.tpl', 85, false),array('modifier', 'nl2br', 'index.tpl', 226, false),)), $this); ?>
...
<div id="content-left">
	<div id="content-left-in">
		...
		<?php if ($this->_tpl_vars['isUpdated']): ?>
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "updateNotify.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
			<br />
...
">
												<?php echo ((is_array($_tmp=$this->_tpl_vars['myprojects'][$this->_sections['project']['index']]['name'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 33, "...", true) : smarty_modifier_truncate($_tmp, 33, "...", true)); ?>
...
&nbsp;&nbsp;</td>
									<td class="tools">
										<?php if ($this->_tpl_vars['userpermissions']['projects']['edit']): ?>
											<a class="tool_edit" href="javascript:void(0);" onclick = "change('manageproject.php?action=editform&amp;id=<?php echo $this->_tpl_vars['myprojects'][$this->_sections['project']['index']]['ID']; ?>
','form_addmyproject');toggleClass(this,'tool_edit_active','tool_edit');blindtoggle('form_addmyproject');" title="<?php echo $this->_config[0]['vars']['edit']; ?>
"></a><?php endif; ?>
...
"></a>
					...
					<div class="tablemenue">
						<div class="tablemenue-in">
							<?php if ($this->_tpl_vars['userpermissions']['projects']['add']): ?>
								<a class="butn_link" href="javascript:blindtoggle('form_addmyproject');" id="add_butn_myprojects" onclick="toggleClass('add_myprojects','add-active','add');toggleClass(this,'butn_link_active','butn_link');toggleClass('sm_deskprojects','smooth','nosmooth');"><?php echo $this->_config[0]['vars']['addproject']; ?>
</a>
							<?php endif; ?>
						</div>
					</div>
				</div> 			   </div> 			</div> 			<div class="content-spacer"></div>
		<?php endif; ?>
...
"><span><?php echo $this->_config[0]['vars']['rssfeed']; ?>
								...
								<a class="pdf" href="mytasks.php?action=pdf"><span><?php echo $this->_config[0]['vars']['pdfexport']; ?>
</span></a>
							</div>
						</div>
					</div>
...
">
					<div id = "form_addmytask" class="addmenue" style = "display:none;">
						<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "addmytask_index.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
					</div>
...
">
											<?php if ($this->_tpl_vars['tasks'][$this->_sections['task']['index']]['title'] != ""): ?>
												<?php echo ((is_array($_tmp=$this->_tpl_vars['tasks'][$this->_sections['task']['index']]['title'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 33, "...", true) : smarty_modifier_truncate($_tmp, 33, "...", true)); ?>

											<?php else: ?>
												<?php echo ((is_array($_tmp=$this->_tpl_vars['tasks'][$this->_sections['task']['index']]['text'])) ? $this->_run_mod_handler('truncate', true, $_tmp, 33, "...", true) : smarty_modifier_truncate($_tmp, 33, "...", true)); ?>
...
&nbsp;&nbsp;</td>
									<td class="tools">
										<?php if ($this->_tpl_vars['userpermissions']['tasks']['edit']): ?>
											<a class="tool_edit" href="javascript:void(0);"  onclick = "change('managetask.php?action=editform&amp;tid=<?php echo $this->_tpl_vars['tasks'][$this->_sections['task']['index']]['ID']; ?>
&amp;id=<?php echo $this->_tpl_vars['tasks'][$this->_sections['task']['index']]['project']; ?>
','form_addmytask');toggleClass(this,'tool_edit_active','tool_edit');blindtoggle('form_addmytask');" title="<?php echo $this->_config[0]['vars']['edit']; ?>
"></a>
					...
					<div class="tablemenue">
						<div class="tablemenue-in">
							<?php if ($this->_tpl_vars['userpermissions']['tasks']['add']): ?>
								<a class="butn_link" href="javascript:void(0);" id="add_butn_mytasks" onclick="blindtoggle('form_addmytask');toggleClass(this,'butn_link_active','butn_link');toggleClass('sm_desktoptasks','smooth','nosmooth');"><?php echo $this->_config[0]['vars']['addtask']; ?>
</a>
							<?php endif; ?>
						</div>
					</div>
