...
:</label>
            ...
            <label><?php echo $this->_config[0]['vars']['milestones']; ?>
             ...
             <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_milestones[view]" /><?php echo $this->_config[0]['vars']['view']; ?>
            ...
            <label><?php echo $this->_config[0]['vars']['tasks']; ?>
             ...
             <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_tasks[view]" /><?php echo $this->_config[0]['vars']['view']; ?>
            ...
            <label><?php echo $this->_config[0]['vars']['messages']; ?>
             ...
             <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_messages[view]" /><?php echo $this->_config[0]['vars']['view']; ?>
            ...
            <label><?php echo $this->_config[0]['vars']['files']; ?>
             ...
             <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_files[del]" /><?php echo $this->_config[0]['vars']['view']; ?>
            ...
            <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_timetracker[view]" /><?php echo $this->_config[0]['vars']['view']; ?>
