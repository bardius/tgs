<?php /* Smarty version 2.6.19, created on 2013-08-05 19:44:31
...
:</label>
            ...
            <label><?php echo $this->_config[0]['vars']['milestones']; ?>
             ...
             <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_milestones[view]" <?php if ($this->_tpl_vars['roles'][$this->_sections['role']['index']]['milestones']['view']): ?>checked<?php endif; ?>  /><?php echo $this->_config[0]['vars']['view']; ?>
            ...
            <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_tasks[view]" <?php if ($this->_tpl_vars['roles'][$this->_sections['role']['index']]['tasks']['view']): ?>checked<?php endif; ?>  /><?php echo $this->_config[0]['vars']['view']; ?>
            ...
            <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_messages[view]" <?php if ($this->_tpl_vars['roles'][$this->_sections['role']['index']]['messages']['view']): ?>checked<?php endif; ?>  /><?php echo $this->_config[0]['vars']['view']; ?>
            ...
            <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_files[view]" <?php if ($this->_tpl_vars['roles'][$this->_sections['role']['index']]['files']['view']): ?>checked<?php endif; ?>  /><?php echo $this->_config[0]['vars']['view']; ?>
            ...
            <div class = "row">
            <label></label><input type = "checkbox" class = "checkbox" value = "1" name = "permissions_timetracker[view]" <?php if ($this->_tpl_vars['roles'][$this->_sections['role']['index']]['timetracker']['view']): ?>checked<?php endif; ?>  /><?php echo $this->_config[0]['vars']['view']; ?>
