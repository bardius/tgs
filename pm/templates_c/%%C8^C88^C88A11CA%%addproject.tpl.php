...
:</label>
				<input type="text" class="text" name="end"  id="endP"  realname="<?php echo $this->_config[0]['vars']['due']; ?>
"  />
		<br /><br />
		<label for = "neverdue"></label><input type = "checkbox" class = "checkbox" value = "neverdue" name = "neverdue" id = "neverdue" onclick = "$('endP').value='';$('endP').disabled='disabled';"><?php echo $this->_config[0]['vars']['neverdue']; ?>
